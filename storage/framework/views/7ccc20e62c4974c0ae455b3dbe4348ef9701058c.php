...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label><?php echo e(trans('update.subtitle')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                           value="<?php echo e(!empty($category) ? $category->subtitle : old('subtitle')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.category_url_hint')); ?></div>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.category_order_hint')); ?></div>
                                    <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="cover_image" id="cover_image" value="<?php echo e(!empty($category) ? $category->cover_image : old('cover_image')); ?>" class="form-control <?php $__errorArgs = ['cover_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                        <div class="invalid-feedback"><?php $__errorArgs = ['cover_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="input-label"><?php echo e(trans('update.icon2')); ?></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" name="icon2" id="icon2" value="<?php echo e(!empty($category) ? $category->icon2 : old('icon2')); ?>" class="form-control <?php $__errorArgs = ['icon2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                                <div class="invalid-feedback"><?php $__errorArgs = ['icon2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('update.icon2_box_color')); ?></label>

                                            <div class="input-group colorpickerinput">
                                                <input type="text" name="icon2_box_color"
                                                       autocomplete="off"
                                                       class="form-control  <?php $__errorArgs = ['icon2_box_color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                       value="<?php echo e(!empty($category) ? $category->icon2_box_color : old('icon2_box_color')); ?>"
                                                />
                                                ...
                                                <?php $__errorArgs = ['icon2_box_color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label class="input-label"><?php echo e(trans('update.overlay_image')); ?></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="overlay_image" id="overlay_image" value="<?php echo e(!empty($category) ? $category->overlay_image : old('overlay_image')); ?>" class="form-control <?php $__errorArgs = ['overlay_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                        <div class="invalid-feedback"><?php $__errorArgs = ['overlay_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                ...
                                <div class="form-group">
                                    <label class="input-label"><?php echo e(trans('update.bottom_seo_title')); ?></label>
                                    <input type="text" name="bottom_seo_title" class="form-control" value="<?php echo e(!empty($category) ? $category->bottom_seo_title : old('bottom_seo_title')); ?>">
                                </div>

                                <div class="form-group">
                                    <label class="input-label"><?php echo e(trans('update.bottom_seo_content')); ?></label>
                                    <textarea name="bottom_seo_content" class="form-control" rows="5"><?php echo e(!empty($category) ? $category->bottom_seo_content : old('bottom_seo_title')); ?></textarea>
                                </div>
                                            ...
                                            <?php $__currentLoopData = $subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="form-group list-group">
                                                    ...
                                                    <div class="p-2 border rounded-sm">
                                                        ...
                                                        <div class="input-group w-100 mt-1">
                                                            <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][subtitle]"
                                                                   class="form-control w-auto flex-grow-1"
                                                                   value="<?php echo e($subCategory->subtitle); ?>"
                                                                   placeholder="<?php echo e(trans('update.choose_subtitle')); ?>"/>
                                                        </div>

                                                        <div class="input-group mt-1">
                                                            <div class="input-group-prepend">
                                                                <button type="button" class="input-group-text admin-file-manager " data-input="cover_image_<?php echo e($subCategory->id); ?>" data-preview="holder">
                                                                    <i class="fa fa-upload"></i>
                                                                </button>
                                                            </div>
                                                            <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][cover_image]" id="cover_image_<?php echo e($subCategory->id); ?>" class="form-control" value="<?php echo e($subCategory->cover_image); ?>" placeholder="<?php echo e(trans('admin/main.cover_image')); ?>"/>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="input-group mt-1">
                                                                    <div class="input-group-prepend">
                                                                        <button type="button" class="input-group-text admin-file-manager " data-input="icon2_<?php echo e($subCategory->id); ?>" data-preview="holder">
                                                                            <i class="fa fa-upload"></i>
                                                                        </button>
                                                                    </div>
                                                                    <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][icon2]" id="icon2_<?php echo e($subCategory->id); ?>" class="form-control" value="<?php echo e($subCategory->icon2); ?>" placeholder="<?php echo e(trans('update.icon2')); ?>"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="input-group mt-1 colorpickerinput">
                                                                    <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][icon2_box_color]"
                                                                           autocomplete="off"
                                                                           class="form-control"
                                                                           value="<?php echo e($subCategory->icon2_box_color); ?>"
                                                                           placeholder="<?php echo e(trans('update.icon2_box_color')); ?>"
                                                                    />
                                                                    <div class="input-group-append">
                                                                        <div class="input-group-text">
                                                                            <i class="fas fa-fill-drip"></i>
                                                        ...
                                                        <div class="input-group mt-1">
                                                            <div class="input-group-prepend">
                                                                <button type="button" class="input-group-text admin-file-manager " data-input="overlay_image_<?php echo e($subCategory->id); ?>" data-preview="holder">
                                                                    <i class="fa fa-upload"></i>
                                                                </button>
                                                            </div>
                                                            <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][overlay_image]" id="overlay_image_<?php echo e($subCategory->id); ?>" class="form-control" value="<?php echo e($subCategory->overlay_image); ?>" placeholder="<?php echo e(trans('update.overlay_image')); ?>"/>
                                                        </div>

                                                        <div class="input-group mt-1">
                                                            <input type="text" name="sub_categories[<?php echo e($subCategory->id); ?>][bottom_seo_title]" class="form-control" value="<?php echo e($subCategory->bottom_seo_title); ?>" placeholder="<?php echo e(trans('update.bottom_seo_title')); ?>">
                                                        </div>

                                                        <div class="input-group mt-1">
                                                            <textarea name="sub_categories[<?php echo e($subCategory->id); ?>][bottom_seo_content]" class="form-control" rows="5" placeholder="<?php echo e(trans('update.bottom_seo_content')); ?>"><?php echo e($subCategory->bottom_seo_content); ?></textarea>
                                                        </div>
                            ...
                            <li class="form-group main-row list-group d-none">
                                <div class="p-2 border rounded-sm">
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input type="text" name="sub_categories[record][cover_image]" id="cover_image_record" class="form-control" placeholder="<?php echo e(trans('admin/main.cover_image')); ?>"/>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="input-group mt-1">
                                                ...
                                                <input type="text" name="sub_categories[record][icon2]" id="icon2_record" class="form-control" value="" placeholder="<?php echo e(trans('update.icon2')); ?>"/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="input-group mt-1 colorpickerinput">
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input type="text" name="sub_categories[record][overlay_image]" id="overlay_image_record" class="form-control" value="" placeholder="<?php echo e(trans('update.overlay_image')); ?>"/>
                                    </div>

                                    <div class="input-group mt-1">
                                        <input type="text" name="sub_categories[record][bottom_seo_title]" class="form-control" value="" placeholder="<?php echo e(trans('update.bottom_seo_title')); ?>">
                                    </div>

                                    <div class="input-group mt-1">
                                        <textarea name="sub_categories[record][bottom_seo_content]" class="form-control" rows="5" placeholder="<?php echo e(trans('update.bottom_seo_content')); ?>"></textarea>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>