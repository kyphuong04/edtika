                                ...
                                <div class="col-12 col-md-6">
                                    <form action="<?php echo e(getAdminPanelUrl('/certificates/settings')); ?>" method="post">
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <div class="text-gray-500 text-small"><?php echo e(trans('update.certificate_setting_active_hint')); ?></div>
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="text-gray-500 font-12 mt-1"><?php echo e(trans('update.certificate_api_user_id_hint')); ?></p>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="text-gray-500 font-12 mt-1"><?php echo e(trans('update.certificate_api_key_hint')); ?></p>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/certificates/settings/index.blade.php ENDPATH**/ ?>