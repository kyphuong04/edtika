...
<div class="d-none" id="webinarPrerequisitesModal">
    ...
    <div class="js-prerequisites-form" data-action="<?php echo e(getAdminPanelUrl()); ?>/prerequisites/store" >
        ...
        <div class="form-group mt-15">
            ...
            <select id="prerequisitesSelect" name="prerequisite_id" class="js-ajax-prerequisite_id form-control prerequisites-select" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" data-placeholder="<?php echo e(trans('public.search_prerequisites')); ?>">
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/modals/prerequisites.blade.php ENDPATH**/ ?>