...
<?php endif; ?>
                                    ...
                                    <?php if($user->isTeacher() || $user->isOrganization() || $user->isAdmin()): ?>
...
<?php endif; ?>
                                ...
                                <?php if(!empty($user) and ($user->isTeacher() || $user->isOrganization() || $user->isAdmin())): ?>
...
<?php endif; ?>
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span class="font-16 font-weight-bold d-block"><?php echo e(($user->isTeacher() || $user->isOrganization()) ? $user->getActiveWebinars(true) : 0); ?></span>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>