...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="number" name="capacity" class="js-ajax-capacity form-control" placeholder="<?php echo e(trans('forms.empty_means_unlimited')); ?>"/>
            <div class="invalid-feedback"></div>
            <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.price_plan_modal_capacity_hint')); ?></div>
        </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/modals/ticket.blade.php ENDPATH**/ ?>