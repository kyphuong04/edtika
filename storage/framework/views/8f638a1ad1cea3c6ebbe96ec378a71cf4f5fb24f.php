                    ...
                    <div class="table-responsive">
                        <table class="table custom-table font-14" id="datatable-basic">
                            ...
                            <tr>
                                ...
                                <th class="text-center"><?php echo e(trans('notification.receiver')); ?></th>
                            ...
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e($notification->senderUser->full_name); ?></td>

                                    <td class="text-center">
                                        <?php if(!empty($notification->user)): ?>
                                            <span class="d-block"><?php echo e($notification->user->full_name); ?></span>
                                            <span class="text-gray-500 font-12">ID: <?php echo e($notification->user->id); ?></span>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/notifications/posted.blade.php ENDPATH**/ ?>