<div class="position-fixed position-bottom-0 position-left-0 position-right-0 z-index-3 bg-white soft-shadow-2">
    <div class="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between py-16">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="<?php echo e((!empty($bundle) and $currentStep > 1) ? ("/panel/bundles/{$bundle->id}/step/" . ($currentStep - 1)) : '#!'); ?>" class="d-flex-center size-48 rounded-circle bg-gray-100">
                <?php echo e(svg("iconsax-lin-arrow-left", ['height' => 16, 'width' => 16, 'class' => (!empty($bundle) and $currentStep > 1) ? 'text-primary' : 'text-gray-500'])); ?>
            </a>
        ...
        <div class="d-flex align-items-center mt-20 mt-lg-0 gap-8">
            ...
            <button type="button" id="sendForReview" class="btn btn-lg btn-primary ml-16"><?php echo e(trans('public.send_for_review')); ?></button>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/bundles/create/includes/bottom_actions.blade.php ENDPATH**/ ?>