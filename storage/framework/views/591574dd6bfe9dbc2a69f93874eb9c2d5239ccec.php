...
<?php endif; ?>
            ...
            <div class="ml-8">
                <h5 class="font-14 font-weight-bold"><?php echo e(trans('public.prerequisites')); ?></h5>
                <p class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.add_prerequisites_and_let_users_have_a_better_learning_experience')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 mt-20">
            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.prerequisite', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="col-lg-6 mt-36">
            <?php if(!empty($webinar->prerequisites) and count($webinar->prerequisites)): ?>
                <div class="p-16 rounded-16 border-gray-200">
                    <h3 class="font-14 font-weight-bold"><?php echo e(trans('public.prerequisites')); ?></h3>
                    ...
                    <ul class="draggable-content-lists prerequisites-draggable-lists" data-path="" data-drag-class="prerequisites-draggable-lists">
                        <?php $__currentLoopData = $webinar->prerequisites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prerequisiteInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.prerequisite',['prerequisite' => $prerequisiteInfo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
    ...
    <div class="row">
        <div class="col-lg-6 mt-20">
            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.related_courses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
                ...
                <div class="p-16 rounded-16 border-gray-200">
                    ...
                    <ul class="draggable-content-lists related_courses-draggable-lists" data-path="" data-drag-class="related_courses-draggable-lists">
                        <?php $__currentLoopData = $webinar->relatedCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedCourseInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.related_courses',['relatedCourse' => $relatedCourseInfo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/webinars/create/steps/step_5.blade.php ENDPATH**/ ?>