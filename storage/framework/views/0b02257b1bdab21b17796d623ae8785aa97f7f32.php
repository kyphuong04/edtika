                ...
                <div class="bg-white py-16 rounded-12 mt-16">
                    <div class="d-flex align-items-center px-16">
                        <div class="size-40 rounded-circle bg-gray-100">
                            <img src="<?php echo e($upcomingLiveSession->creator->getAvatar(40)); ?>" alt="" class="img-cover rounded-circle">
                        </div>
                        <div class="ml-8">
                            <span class="d-block font-12 text-dark"><?php echo e(truncate($upcomingLiveSession->creator->full_name, 29)); ?></span>
                            <span class="d-block font-12 text-gray-500 mt-2"><?php echo e($upcomingLiveSession->creator->role->caption); ?></span>
                        </div>
                    </div>
...
<?php endif; ?>
            ...
            <div class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.you_don’t_have_any_upcoming_live_session_you_can_find_your_desired_live_course')); ?></div>
        </div>

        <?php if(!empty($upcomingLiveSessions['offerCourses']) and count($upcomingLiveSessions['offerCourses'])): ?>
            <?php $__currentLoopData = $upcomingLiveSessions['offerCourses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offerCourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($offerCourse->getUrl()); ?>" target="_blank" class="">
                    <div class="d-flex align-items-center justify-content-between bg-gray-100 p-12 rounded-16 mt-16">
                        <div class="d-flex align-items-center">
                            <div class="size-48 rounded-8 bg-gray-100">
                                <img src="<?php echo e($offerCourse->getIcon()); ?>" alt="" class="img-cover rounded-8">
                            </div>
                            <div class="ml-8">
                                <h6 class="font-12 text-dark"><?php echo e(truncate($offerCourse->title, 28)); ?></h6>
...
<?php endif; ?>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16">
            <div class="">
                <h6 class="font-14 text-dark"><?php echo e(trans('update.explore_live_classes')); ?></h6>
                <p class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.find_your_desired_live_class')); ?></p>
            </div>
...
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/panel/dashboard/student/includes/upcoming_live_sessions.blade.php ENDPATH**/ ?>