    ...
    <div class="d-flex align-items-center justify-content-between " role="tab" id="text_lesson_<?php echo e(!empty($textLesson) ? $textLesson->id :'record'); ?>">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($textLesson)): ?>
                <button type="button" data-item-id="<?php echo e($textLesson->id); ?>" data-item-type="<?php echo e(\App\Models\WebinarChapterItem::$chapterTextLesson); ?>" data-chapter-id="<?php echo e(!empty($chapter) ? $chapter->id : ''); ?>" class="js-change-content-chapter btn btn-sm btn-transparent text-gray-500 mr-10">
            ...
            <?php if(!empty($textLesson)): ?>
                <a href="<?php echo e(getAdminPanelUrl()); ?>/text-lesson/<?php echo e($textLesson->id); ?>/delete" class="delete-action btn btn-sm btn-transparent text-gray-500">
        ...
        <div class="panel-collapse text-gray-500">
            <div class="js-content-form text_lesson-form" data-action="<?php echo e(getAdminPanelUrl()); ?>/text-lesson/<?php echo e(!empty($textLesson) ? $textLesson->id . '/update' : 'store'); ?>">
                ...
                <div class="mt-6 d-flex align-items-center">
                    <button type="button" class="js-save-text_lesson btn btn-sm btn-primary size-100"><?php echo e(trans('public.save')); ?></button>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/create_includes/accordions/text-lesson.blade.php ENDPATH**/ ?>