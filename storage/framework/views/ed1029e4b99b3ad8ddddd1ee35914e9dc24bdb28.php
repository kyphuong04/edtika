            ...
            <div class="card-header speaking-premium-header">
                <div class="d-flex align-items-center justify-content-between w-100">
                    <h5 class="text-white font-18 font-weight-bold mb-0">
                        <i class="fas fa-microphone-alt mr-10"></i><?php echo e($group->title ?? 'Speaking Unit'); ?>

                    </h5>
                    <span class="badge badge-part-tag"><?php echo e($partType); ?></span>
                </div>
            </div>
            ...
            <div class="card-body p-24">
                ...
                <div class="d-flex gap-20 mb-20 border-bottom pb-16">
                    <div class="meta-pill">
                        ...
                        <span><?php echo e($current['duration']); ?></span>
                    </div>
                    <div class="meta-pill">
                        <i class="fas fa-layer-group text-success mr-8"></i>
                        <span><?php echo e($group->questions()->count()); ?> Questions</span>
                    </div>
                </div>
                ...
                <?php if($group->instructions): ?>
                    <div class="instruction-box mb-20">
                        ...
                        <div class="instruction-text"><?php echo nl2br(e($group->instructions)); ?></div>
                    </div>
                <?php endif; ?>
                ...
                <?php if($group->passage): ?>
                    <div class="cue-card-container">
                        <div class="cue-card-header">
                            <i class="fas <?php echo e($current['icon']); ?> mr-8"></i>
                            <?php echo e($partType === 'Part 2' ? 'Candidate Task Card' : 'Discussion Topic'); ?>

                        </div>
                        <div class="cue-card-body">
                            <?php echo $group->passage; ?>
                ...
                <div class="mt-24">
                    <a href="<?php echo e(route('panel.question-groups.edit', $group->id)); ?>" class="btn btn-edit-group w-100">
    ...
    <div class="col-lg-7">
        <div class="card shadow-sm border-0 rounded-16 overflow-hidden">
            ...
            <div class="card-body p-0">
                <?php $questions = $group->questions()->orderBy('id')->get(); ?>
                    ...
                    <div class="speaking-list-wrapper">
                        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="speaking-item">
                                <div class="item-number"><?php echo e($index + 1); ?></div>
                                <div class="item-main">
                                    <div class="item-text font-15"><?php echo e($question->question_text); ?></div>
                                ...
                                <div class="item-actions">
                                    <a href="<?php echo e(route('panel.questions.edit', $question->id)); ?>" class="btn-action edit" title="Edit">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form action="<?php echo e(route('panel.questions.destroy', $question->id)); ?>" method="POST" onsubmit="return confirm('Delete?')" class="d-inline">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg modal-premium">
            ...
            <form action="<?php echo e(route('panel.questions.store', $group->id)); ?>" method="POST">
                ...
                <input type="hidden" name="speaking_part" value="<?php echo e($partType); ?>">
                <div class="modal-body p-30">
                    <div class="row mb-20">
                        <div class="col-md-4">
                            <label class="font-weight-bold text-dark font-13">Display Order</label>
                            <input type="number" name="question_number" class="form-control-modern" value="<?php echo e($questions->count() + 1); ?>" required>
                        </div>
                        <div class="col-md-8">
...
</style><?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/panel/question_groups/partials/speaking_part.blade.php ENDPATH**/ ?>