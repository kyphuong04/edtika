    ...
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.total_certificates')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($totalCertificatesCount); ?></h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.quiz_certificates')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($quizCertificatesCount); ?></h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.completion_certificates')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($completionCertificatesCount); ?></h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.not_acheived_certificates')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e(count($pendingCertificates)); ?></h5>
        </div>
    </div>
</div>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/certificates/my_achievements/top_stats.blade.php ENDPATH**/ ?>