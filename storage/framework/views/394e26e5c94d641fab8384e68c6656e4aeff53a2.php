...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(trans('admin/main.all_users')); ?> <?php echo e(trans('admin/main.list')); ?></h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a><?php echo e(trans('admin/main.all_users')); ?></a></div>
                ...
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.total_users')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalUsers); ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap"> 
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.active_users')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($activeUsers); ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.inactive_users')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($inactiveUsers); ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.ban_users')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($banUsers); ?></h5>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="sort" data-plugin-selectTwo class="form-control populate">
                                    ...
                                    <option value="sales_classes_asc" <?php if(request()->get('sort') == 'sales_classes_asc'): ?> selected <?php endif; ?>><?php echo e(trans('admin/main.sales_classes_ascending')); ?></option>
                                    <option value="sales_classes_desc" <?php if(request()->get('sort') == 'sales_classes_desc'): ?> selected <?php endif; ?>><?php echo e(trans('admin/main.sales_classes_descending')); ?></option>
                                    ...
                                    <option value="sales_appointments_asc" <?php if(request()->get('sort') == 'sales_appointments_asc'): ?> selected <?php endif; ?>><?php echo e(trans('admin/main.sales_appointments_ascending')); ?></option>
                                    <option value="sales_appointments_desc" <?php if(request()->get('sort') == 'sales_appointments_desc'): ?> selected <?php endif; ?>><?php echo e(trans('admin/main.sales_appointments_descending')); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="role_id" data-plugin-selectTwo class="form-control populate">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role->id); ?>" <?php if(request()->get('role_id') == $role->id): ?> selected <?php endif; ?>><?php echo e($role->name); ?></option>
    ...
    <div class="card">
        ...
        <div class="card-header justify-content-between">
            <div>
                ...
                <p class="font-12 mt-4 mb-0 text-gray-500"><?php echo e(trans('admin/main.all_users')); ?></p>
            </div>
            
            <div class="d-flex align-items-center gap-12">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_export_excel')): ?>
                    <a href="<?php echo e(getAdminPanelUrl()); ?>/all-users/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
                        <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                ...
                <table class="table custom-table font-14">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                                    ...
                                    <div class="position-relative">
                                        <figure class="avatar mr-2" style="position: relative;">
                                            ...
                                            <?php if($user->verified): ?>
                                                <div style="position: absolute; right: 1px; top: 1px; width: 12px; height: 12px; background-color: #3498db; border-radius: 50%; display: flex; align-items: center; justify-content: center; z-index: 1;" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.verified_instructor')); ?>">
                            ...
                            <td>
                                <?php echo e(optional($user->role)->caption ?? '-'); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/users/all_users.blade.php ENDPATH**/ ?>