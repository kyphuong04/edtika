...
<?php endif; ?>
        ...
        <div class="ml-8">
            <h1 class="font-14 font-weight-bold"><?php echo e($quiz->title); ?></h1>
            <p class="mt-4 font-12 text-gray-500"><?php echo e($webinar->title); ?></p>
        </div>
    </div>

    <a href="<?php echo e($webinar->getLearningPageUrl()); ?>" class="d-flex align-items-center text-gray-500 font-14">
        <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
        <span class="ml-4"><?php echo e(trans('update.back_to_the_course')); ?></span>
    </a>
</div>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/quizzes/holding/start/top_info.blade.php ENDPATH**/ ?>