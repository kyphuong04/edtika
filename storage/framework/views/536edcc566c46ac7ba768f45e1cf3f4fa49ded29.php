<?php if(!empty($featureWebinars) and !$featureWebinars->isEmpty()): ?>
    ...
    <div class="courses-lists-featured bg-primary mt-56" <?php if(!empty($featureWebinarsBackground)): ?> style="background-image: url('<?php echo e($featureWebinarsBackground); ?>')" <?php endif; ?>>
            ...
            <div class="row w-100 h-100">
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="d-flex justify-content-center flex-column text-left w-100 h-100">
                        ...
                        <h3 class="font-24 font-weight-bold text-white"><?php echo e(trans('update.featured_courses')); ?></h3>
                        <div class="mt-8 text-white"><?php echo e(trans('update.explore_hand_picked_and_popular_courses')); ?></div>

                        <?php if(!empty($featureWebinarsOverlayImage)): ?>
                            <div class="d-flex align-items-center mt-32 size-200">
                                <img src="<?php echo e($featureWebinarsOverlayImage); ?>" alt="<?php echo e(trans('update.overlay_image')); ?>" class="img-fluid">
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="position-relative">
                        ...
                        >
                            <div class="swiper-wrapper py-0  mx-16 mx-md-32">
                                <?php echo $__env->make('design_1.web.courses.components.cards.grids.index',['courses' => $featureWebinarsItems, 'gridCardClassName' => "swiper-slide"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/web/courses/lists/includes/featured_courses.blade.php ENDPATH**/ ?>