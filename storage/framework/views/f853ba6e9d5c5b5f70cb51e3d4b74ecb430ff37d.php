        ...
        <div class="col-12 col-md-6">
            <form action="<?php echo e(getAdminPanelUrl()); ?>/users/<?php echo e($user->id); ?>/userRegistrationPackage" method="Post">
                ...
                <div class="form-group custom-switches-stacked">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.user_registration_packages_status_hint')); ?></div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/users/editTabs/registration_package.blade.php ENDPATH**/ ?>