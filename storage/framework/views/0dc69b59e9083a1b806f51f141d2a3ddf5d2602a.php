...
<?php endif; ?>
                ...
                <div class="px-16 text-left">
                    ...
                    <div class="d-flex align-items-center p-16 rounded-16" style="background: var(--primary);">
                        <div class="d-flex-center size-56 bg-white rounded-circle shadow-sm">
                            <img src="<?php echo e(asset('assets/design_1/img/logo.jpg')); ?>" alt="Rocket LMS" class="size-48 rounded-circle" style="object-fit: cover;">
                        </div>
                        <div class="ml-12">
                    ...
                    <div class="mt-16 pt-12 border-top text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-8" style="gap: 8px;">
                            ...
                            <a href="<?php echo e(getAdminPanelUrl('/licenses')); ?>"  class="badge badge-soft-primary font-10 px-8 py-4 text-decoration-none">License Info</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php if(!empty(getAiContentsSettingsName('status')) && !empty(getAiContentsSettingsName('active_for_admin_panel'))): ?>
...
<?php endif; ?>
        ...
        <?php echo $__env->make('admin.includes.header.currency', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        
        <?php echo $__env->make('admin.includes.header.language', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        
        <?php echo $__env->make('admin.includes.header.notification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <div class="admin-header__item-divider"></div>

        
        <?php echo $__env->make('admin.includes.header.auth_user_info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/includes/header/index.blade.php ENDPATH**/ ?>