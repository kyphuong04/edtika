...
unset($__errorArgs, $__bag); ?>" value="<?php echo e((!empty($webinar) and !empty($webinar->price)) ? convertPriceToUserCurrency($webinar->price) : old('price')); ?>" placeholder="<?php echo e(trans('public.0_for_free')); ?>" oninput="validatePrice(this)"/>
...
unset($__errorArgs, $__bag); ?></div>
    ...
    <?php if($authUser->isAdmin() and $authUser->id == $webinar->creator_id): ?>
        <div class="form-group">
            <label class="form-group-label"><?php echo e(trans('update.organization_price')); ?></label>
            <span class="has-translation bg-gray-100 text-gray-500"><?php echo e($currency); ?></span>
            <input type="text" name="organization_price" class="form-control <?php $__errorArgs = ['organization_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e((!empty($webinar) and $webinar->organization_price) ? convertPriceToUserCurrency($webinar->organization_price) : old('organization_price')); ?>" placeholder="" oninput="validatePrice(this)"/>
            <div class="invalid-feedback d-block"><?php $__errorArgs = ['organization_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <p class="font-12 text-gray-500 mt-8">- <?php echo e(trans('update.organization_price_hint')); ?></p>
        </div>
    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(!empty($webinar) ? $webinar->access_days : old('access_days')); ?>"/>
    ...
    <div class="form-group">
        <div class="d-flex align-items-center">
            <div class="custom-switch mr-8">
                <input id="subscribeSwitch" type="checkbox" name="subscribe" class="custom-control-input" <?php echo e((!empty($webinar) and $webinar->subscribe) ? 'checked' :  ''); ?>>
...
<?php endif; ?>
    ...
    <div class="row">
        <div class="col-lg-6">
            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.price_plan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
            ...
            <div class="col-lg-6 mt-20 mt-lg-16">
                <div class="p-16 rounded-16 border-gray-200">
                    ...
                    <ul class="draggable-content-lists price-plan-draggable-lists" data-path="/panel/tickets/orders" data-drag-class="price-plan-draggable-lists">
                        <?php $__currentLoopData = $webinar->tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pricePlan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.price_plan',['plan' => $pricePlan], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/webinars/create/steps/step_3.blade.php ENDPATH**/ ?>