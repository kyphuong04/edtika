                ...
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('update.course_assignments')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($courseAssignmentsCount); ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('update.pending_review')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($pendingReviewCount); ?></h5>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($passedCount); ?></h5>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($failedCount); ?></h5>
                    </div>
                </div>
            </div>
        ...
        <div class="section-body">
            ...
            <div class="card-header justify-content-between">
                            ...
                            <div>
                               ...
                               <p class="font-12 mt-4 mb-0 text-gray-500"><?php echo e(trans('update.manage_all_assignment_in_a_single_place')); ?></p>
                           </div>                           
                ...
                <div class="card-body">
                    <table class="table custom-table font-14" id="datatable-details">
                        ...
                        <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="text-left">
                                    <span class="d-block text-dark"><?php echo e($assignment->title); ?></span>
                                    <span class="d-block font-12 text-gray-500"><?php echo e($assignment->webinar->title); ?></span>
                                </td>

                                <td class="align-middle">
                                    <span><?php echo e(count($assignment->instructorAssignmentHistories)); ?></span>
                                </td>
                                ...
                                <td class="align-middle">
                                    <span class="badge-status <?php echo e(($assignment->status == 'active') ? 'text-success bg-success-30' : 'text-warning bg-warning-30'); ?>"><?php echo e(trans('admin/main.'.$assignment->status)); ?></span>
                                </td>
...
<?php endif; ?>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_reviews_status_toggle')): ?>
                                                <a href="<?php echo e(getAdminPanelUrl()); ?>/assignments/<?php echo e($assignment->id); ?>/students" class="dropdown-item d-flex align-items-center mb-3 py-3 px-0 gap-4">
                                                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
                                                    <span class="text-gray-500 font-14"><?php echo e(trans('public.students')); ?></span>
                                                </a>
                                            <?php endif; ?>

                                                <a href="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e($assignment->webinar_id); ?>/edit" class="dropdown-item d-flex align-items-center mb-3 py-3 px-0 gap-4">
                                                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
                                                    <span class="text-gray-500 font-14"><?php echo e(trans('admin/main.course')); ?></span>
                                                </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/assignments/lists.blade.php ENDPATH**/ ?>