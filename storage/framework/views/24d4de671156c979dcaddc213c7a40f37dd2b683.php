            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="<?php echo e(getAdminPanelUrl()); ?>/webinars?type=course&sort=sales_desc" class="btn btn-sm btn-primary"><?php echo e(trans('admin/main.view_more')); ?><i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table custom-table font-14 ">
                                ...
                                <?php $__currentLoopData = $getTopSellingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e($getTopSellingClass->getUrl()); ?>" target="_blank" class="media-body text-dark text-left">
                                                <div class="text-dark"><?php echo e($getTopSellingClass->title); ?></div>
                                                <div class="text-gray-500 text-small"><?php echo e(trans('webinars.'.$getTopSellingClass->type)); ?></div>
                                            </a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/marketing_dashboard.blade.php ENDPATH**/ ?>