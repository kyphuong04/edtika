            ...
            <form action="<?php echo e(getAdminPanelUrl()); ?>/settings/general_options" method="post">
                ...
                <div class="mb-5">
                    ...
                    <?php $__currentLoopData = $directPublicationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $directPublicationOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-group mt-3 custom-switches-stacked">
                            ...
                            <p class="font-12 text-gray-500 mb-0"><?php echo e(trans("update.{$directPublicationOption}_hint")); ?></p>
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        ...
                        <p class="font-12 text-gray-500 mb-0"><?php echo e(trans("update.allow_instructor_delete_content_hint")); ?></p>
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        ...
                        <p class="font-12 text-gray-500 mb-0"><?php echo e(trans("update.disable_registration_verification_process_hint")); ?></p>
                    </div>

                    <div class="form-group mt-3">
                        <label><?php echo e(trans('update.duration_of_resend_verification_code')); ?> (<?php echo e(trans('public.minutes')); ?>)</label>
                        <input type="number" name="value[duration_of_resend_verification_code]" class="form-control" value="<?php echo e((!empty($itemValue) and !empty($itemValue['duration_of_resend_verification_code'])) ? $itemValue['duration_of_resend_verification_code'] : ''); ?>">
                        <p class="font-12 text-gray-500 mt-1"><?php echo e(trans("update.duration_of_resend_verification_code_hint")); ?></p>
                    </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/settings/general/options.blade.php ENDPATH**/ ?>