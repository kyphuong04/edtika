<?php if(!empty($mostActiveCourses) and count($mostActiveCourses)): ?>
    <div class="mt-28">
        <div class="">
            <h2 class="font-16 text-dark"><?php echo e(trans('update.most_active_courses')); ?></h2>
            <p class="font-12 mt-4 text-gray-500"><?php echo e(trans('update.check_courses_with_most_generated_certificates')); ?></p>
        </div>
                    ...
                    <div class="position-relative z-index-2 bg-white p-20 rounded-16">
                        <div class="d-flex align-items-center p-4">
                            ...
                            <div class="ml-8">
                                ...
                                <?php echo $__env->make('design_1.web.components.rate', ['rate' => 3, 'rateClassName' => 'mt-4'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
...
<?php endif; ?>
                                ...
                                <div class="ml-8">
                                    ...
                                    <p class="font-12 text-gray-500 mt-4"><?php echo e(trans('update.certificates_generated')); ?></p>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/certificates/students/most_active_courses.blade.php ENDPATH**/ ?>