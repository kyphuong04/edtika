        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <p class="font-12 text-gray-500 mt-1 mb-0"><?php echo e(trans('update.webinar_reminder_hint')); ?></p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="font-12 text-gray-500 mt-1 mb-0"><?php echo e(trans('update.meeting_reminder_hint')); ?></p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="font-12 text-gray-500 mt-1 mb-0"><?php echo e(trans('update.subscribe_reminder_hint')); ?></p>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/settings/general/reminders.blade.php ENDPATH**/ ?>