                ...
                <div class="d-flex align-items-center justify-content-between bg-white p-12 rounded-12">
                    <div class="d-flex align-items-center">
                        <div class="size-48 rounded-circle bg-gray-100">
                            <img src="<?php echo e($openReserveMeeting->user->getAvatar()); ?>" alt="" class="rounded-circle img-cover">
                        </div>
                        <div class="ml-8">
                            <h6 class="font-14 text-dark"><?php echo e(truncate($openReserveMeeting->user->full_name, 28)); ?></h6>
...
<?php endif; ?>
                        ...
                        <input type="hidden" class="js-meeting-password-<?php echo e($openReserveMeeting->id); ?>" value="<?php echo e($openReserveMeeting->password); ?>">
                        <input type="hidden" class="js-meeting-link-<?php echo e($openReserveMeeting->id); ?>" value="<?php echo e($openReserveMeeting->link); ?>">
                    </div>
                </div>
            </div>
...
<?php endif; ?>
            ...
            <div class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.instructor_dashboard_no_meeting_hint')); ?></div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mt-16">
            <div class="">
                <h6 class="font-14 text-dark"><?php echo e(trans('update.meeting_settings')); ?></h6>
                <p class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.configure_your_meetings')); ?></p>
            </div>
...
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/panel/dashboard/instructor/includes/open_meetings.blade.php ENDPATH**/ ?>