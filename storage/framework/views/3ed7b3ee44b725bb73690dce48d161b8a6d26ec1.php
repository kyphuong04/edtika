...
<?php endif; ?>
    ...
    <div id="collapsePricePlan<?php echo e(!empty($plan) ? $plan->id :'record'); ?>" class="accordion__collapse <?php echo e(empty($plan) ? 'show' : ''); ?>" role="tabpanel">
        <div class="js-content-form js-price_plan-form mt-20" data-action="/panel/tickets/<?php echo e(!empty($plan) ? $plan->id . '/update' : 'store'); ?>">
            <input type="hidden" name="ajax[<?php echo e(!empty($plan) ? $plan->id : 'new'); ?>][webinar_id]" value="<?php echo e(!empty($webinar) ? $webinar->id :''); ?>">
...
<?php endif; ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <?php if(empty($plan) and !empty($webinar->capacity) and !empty($sumTicketsCapacities)): ?>
                            <div class="test-gray-500 font-12 mt-8"><?php echo e(trans('panel.remaining')); ?>: <span class="js-ticket-remaining-capacity"><?php echo e($webinar->capacity - $sumTicketsCapacities); ?></span></div>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/webinars/create/includes/accordions/price_plan.blade.php ENDPATH**/ ?>