<?php if(!empty($products) and $products->isNotEmpty()): ?>
    <div id="profileProductsRow" class="row">
        <?php echo $__env->make('design_1.web.products.components.cards.grids.index',['products' => $products, 'gridCardClassName' => "col-12 col-lg-6 mt-16"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>

    <?php if(!empty($hasMoreProducts)): ?>
        <div class="d-flex-center mt-16">
            <div class="js-profile-tab-load-more-btn btn border-dashed border-gray-300 rounded-12 bg-white bg-hover-gray-100 cursor-pointer" data-path="/users/<?php echo e($user->getUsername()); ?>/get-products" data-el="profileProductsRow">
...
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/web/users/profile/tabs/products.blade.php ENDPATH**/ ?>