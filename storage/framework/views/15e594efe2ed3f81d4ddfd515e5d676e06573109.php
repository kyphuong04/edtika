...
<?php endif; ?>
    ...
    <div id="collapseFaq<?php echo e(!empty($faq) ? $faq->id :'record'); ?>" class="accordion__collapse <?php echo e(empty($faq) ? 'show' : ''); ?>" role="tabpanel">
        <div class="js-content-form js-faq-form mt-20" data-action="/panel/faqs/<?php echo e(!empty($faq) ? $faq->id . '/update' : 'store'); ?>">
            <input type="hidden" name="ajax[<?php echo e(!empty($faq) ? $faq->id : 'new'); ?>][webinar_id]" value="<?php echo e(!empty($webinar) ? $webinar->id :''); ?>">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <?php echo $__env->make('design_1.panel.includes.locale.locale_select',[
                        ...
                        'extraData' => "data-webinar-id='".(!empty($webinar) ? $webinar->id : '')."'  data-id='".(!empty($faq) ? $faq->id : '')."'  data-relation='faqs' data-fields='title,answer'"
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/webinars/create/includes/accordions/faq.blade.php ENDPATH**/ ?>