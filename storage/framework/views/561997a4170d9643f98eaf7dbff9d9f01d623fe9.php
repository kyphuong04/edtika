...
<?php $component->withName('iconsax-lin-add-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-primary mr-8','width' => '18','height' => '18']); ?>
...
<?php endif; ?>Add Question
        ...
        <button type="button" id="resetFormBtn" class="btn btn-sm btn-outline-secondary">
            <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-lin-refresh'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-4','width' => '14','height' => '14']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
        ...
        <form id="questionForm">
            ...
            <div class="d-flex gap-12 mb-16">
                <div style="width: 100px;">
                    ...
                    <input type="number" name="question_number" id="question_number" 
                           ...
                           value="<?php echo e($nextQuestionNumber); ?>" min="1" required style="font-weight: 600;">
                </div>
                <div class="flex-fill">
            ...
            <div id="typeSpecificFields">
                ...
                <div id="selectTypePrompt" class="text-center py-24 bg-gray-50 rounded-12">
                    <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-lin-mouse-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-gray-400 mb-12','width' => '48','height' => '48']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
                ...
                <?php if($group->skill === 'reading'): ?>
                    <div class="question-type-form" data-type="multiple_choice_single" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.multiple_choice_single', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="multiple_choice_multiple" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.multiple_choice_multiple', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="true_false_not_given" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.true_false_not_given', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="yes_no_not_given" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.yes_no_not_given', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="matching_headings" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.matching_headings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="matching_information" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.matching_information', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="matching_features" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.matching_features', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="matching_sentence_endings" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.matching_sentence_endings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="sentence_completion" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.sentence_completion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="summary_completion" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.summary_completion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="note_completion" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.note_completion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="table_completion" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.table_completion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="diagram_labeling" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.diagram_labeling', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="short_answer" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.short_answer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                <?php elseif($group->skill === 'listening'): ?>
                    <div class="question-type-form" data-type="multiple_choice_single" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.multiple_choice_single', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="question-type-form" data-type="form_completion" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.form_completion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="note_completion" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.note_completion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="question-type-form" data-type="flow_chart" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.flow_chart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="map_labeling" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.map_labeling', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="question-type-form" data-type="diagram_labeling" style="display:none;">
                        <?php echo $__env->make('design_1.panel.questions.types.diagram_labeling', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons mr-8','width' => '18','height' => '18']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>Add to List
                </button>
            </div>
        </form>
    </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-success mr-8','width' => '18','height' => '18']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
        ...
        <button type="button" id="saveAllQuestionsBtn" class="btn btn-success btn-sm">
            <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-lin-cloud'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons mr-8','width' => '16','height' => '16']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<div class="mt-20">
    <div class="d-flex align-items-center justify-content-between mb-12">
        <h6 class="font-12 font-weight-bold text-gray-600 text-uppercase mb-0">
            <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-lin-archive'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>Saved Questions (<?php echo e($group->questions->count()); ?>)
        </h6>
    </div>
    
    <?php if($group->questions->count() > 0): ?>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="flex-fill">
                            <div class="d-flex align-items-center mb-8">
                                <span class="badge badge-primary mr-12" style="min-width: 32px;">Q<?php echo e($question->question_order ?? $question->question_number ?? $loop->iteration); ?></span>
                                <span class="badge badge-light text-primary font-11"><?php echo e($questionTypeLabel); ?></span>
                            </div>
                            <?php if($questionText): ?>
                                <p class="font-13 text-dark mb-8" style="line-height: 1.5;"><?php echo e(Str::limit($questionText, 150)); ?></p>
                            <?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-success mr-4','width' => '14','height' => '14']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
                                    <strong>Answer:</strong> <?php echo $answerDisplay; ?>

                                </div>
                                <?php if($question->word_limit): ?>
                                    <span class="badge badge-secondary font-10">Max <?php echo e($question->word_limit); ?> word(s)</span>
                                <?php endif; ?>
                                <?php if($question->alternative_answers): ?>
                                    <span class="font-11 text-muted">Alt: <?php echo e(is_array(json_decode($question->alternative_answers)) ? implode(', ', json_decode($question->alternative_answers)) : $question->alternative_answers); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-8 ml-12">
                            <a href="<?php echo e(route('panel.questions.edit', $question->id)); ?>" class="btn btn-sm btn-light" title="Edit">
                                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-primary','width' => '16','height' => '16']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
                            ...
                            <form action="<?php echo e(route('panel.questions.destroy', $question->id)); ?>" method="POST" 
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-danger','width' => '16','height' => '16']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-gray-300 mb-8','width' => '48','height' => '48']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
$(document).ready(function() {
    ...
    $('#saveAllQuestionsBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("panel.questions.store", $group->id)); ?>',
            method: 'POST',
            data: {
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/question_groups/partials/question_form_rl.blade.php ENDPATH**/ ?>