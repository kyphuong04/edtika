<div class="add-answer-card mt-28 <?php echo e((empty($answer) or (!empty($loop) and $loop->iteration == 1)) ? 'main-answer-row' : ''); ?>">
    ...
    <div class="row mt-2 align-items-end">
        ...
        <div class="col-12 col-md-12">
            <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                <label class="js-switch" for="correctAnswerSwitch_<?php echo e(!empty($answer) ? $answer->id : 'ans_tmp'); ?>"><?php echo e(trans('quiz.correct_answer')); ?></label>
                <div class="custom-control custom-switch">
                    <input id="correctAnswerSwitch_<?php echo e(!empty($answer) ? $answer->id : 'ans_tmp'); ?>" type="checkbox" name="ajax[answers][<?php echo e(!empty($answer) ? $answer->id : 'ans_tmp'); ?>][correct]" <?php if(!empty($answer) and $answer->correct): ?> checked <?php endif; ?> class="custom-control-input js-switch">
                    <label class="custom-control-label js-switch" for="correctAnswerSwitch_<?php echo e(!empty($answer) ? $answer->id : 'ans_tmp'); ?>"></label>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/quizzes/modals/multiple_answer_form.blade.php ENDPATH**/ ?>