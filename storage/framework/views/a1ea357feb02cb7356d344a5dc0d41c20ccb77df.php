...
<?php endif; ?>
    ...
    <div class="row">
        <div class="col-lg-6 mt-20">
            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.faq', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
                ...
                <div class="p-16 rounded-16 border-gray-200">
                    ...
                    <ul class="draggable-content-lists faq-draggable-lists" data-path="" data-drag-class="faq-draggable-lists">
                        <?php $__currentLoopData = $webinar->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faqInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.faq',['faq' => $faqInfo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
            ...
            <div class="ml-8">
                <h5 class="font-14 font-weight-bold"><?php echo e(trans('update.learning_materials')); ?></h5>
                <p class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.add_FAQ_and_display_them_on_the_course_page')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 mt-20">
            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.extra_description', [
        ...
        <div class="col-lg-6 mt-36">
            <?php if(!empty($learningMaterials) and count($learningMaterials)): ?>
                <div class="p-16 rounded-16 border-gray-200">
                    <h3 class="font-14 font-weight-bold"><?php echo e(trans('update.learning_materials')); ?></h3>

                    <ul class="draggable-content-lists faq-draggable-lists" data-path="" data-drag-class="faq-draggable-lists">
                        <?php $__currentLoopData = $learningMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $learningMaterial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('design_1.panel.webinars.create.includes.accordions.extra_description',
                                    [
                                        'webinar' => $webinar,
...
<?php endif; ?>
                    ...
                    <h3 class="font-16 font-weight-bold mt-12"><?php echo e(trans('update.learning_materials_no_result')); ?></h3>
                    <p class="mt-4 font-12 text-gray-500"><?php echo trans('update.learning_materials_no_result_hint'); ?></p>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="ml-8">
                <h5 class="font-14 font-weight-bold"><?php echo e(trans('update.requirements')); ?></h5>
                <p class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.add_FAQ_and_display_them_on_the_course_page')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mt-36">
            <?php if(!empty($requirements) and count($requirements)): ?>
                <div class="p-16 rounded-16 border-gray-200">
                    <h3 class="font-14 font-weight-bold"><?php echo e(trans('update.requirements')); ?></h3>
...
<?php endif; ?>
                    ...
                    <h3 class="font-16 font-weight-bold mt-12"><?php echo e(trans('update.requirements_no_result')); ?></h3>
                    <p class="mt-4 font-12 text-gray-500"><?php echo trans('update.requirements_no_result_hint'); ?></p>
                </div>
            <?php endif; ?>
    ...
    <div class="d-flex align-items-center justify-content-between mt-32 p-12 rounded-16 border-gray-300 border-dashed">
        <div class="d-flex align-items-center">
            <div class="d-flex-center size-48 bg-primary-20 rounded-12">
                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-bul-shapes'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
            ...
            <div class="ml-8">
                <h5 class="font-14 font-weight-bold"><?php echo e(trans('update.company_logos')); ?></h5>
                <p class="mt-4 font-12 text-gray-500"><?php echo e(trans('update.display_company_logos_on_the_course_page')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="border-dashed border-gray-300 rounded-16 p-28 mt-16">
        <?php echo $__env->make("design_1.panel.webinars.create.includes.accordions.company_logos", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/webinars/create/steps/step_6.blade.php ENDPATH**/ ?>