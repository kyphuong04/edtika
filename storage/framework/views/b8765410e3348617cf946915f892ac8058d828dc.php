    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="<?php echo e(getAdminPanelUrl()); ?>/filters"><?php echo e(trans('admin/main.filters')); ?></a>
                </div>
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo e(getAdminPanelUrl()); ?>/filters/<?php echo e(!empty($filter) ? $filter->id.'/update' : 'store'); ?>"
                                  method="Post">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/filters/create.blade.php ENDPATH**/ ?>