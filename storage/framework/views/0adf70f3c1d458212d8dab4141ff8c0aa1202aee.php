...
<section>
    ...
    <div class="d-flex align-items-center justify-content-between mb-24">
        <div>
            <h1 class="font-20 font-weight-bold text-dark">Import <?php echo e(ucfirst($skill)); ?> Questions</h1>
            <p class="text-gray-500 font-14 mt-4">Batch upload with Excel + <?php echo e($skill === 'listening' ? 'Audio' : 'Image'); ?> files via ZIP</p>
        </div>
        <a href="<?php echo e(route('panel.question_bank')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="bg-white p-20 rounded-24 mb-24">
                ...
                <form method="POST" action="<?php echo e(route('panel.question_bank.import.preview')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-20">
                        <label class="font-12 text-gray-500 mb-8">ZIP File * (Excel + <?php echo e($skill === 'listening' ? 'Audio' : 'Images'); ?>)</label>
                        <div class="border-dashed border-gray-200 rounded-16 p-32 text-center bg-gray-100">
                            ...
                            <label for="zip_file" class="cursor-pointer">
                                <div class="d-flex-center size-64 rounded-16 bg-primary-40 mx-auto mb-12">
                                    <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-bul-archive'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-success mr-12','width' => '20px','height' => '20px']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
                                <div>
                                    <strong class="font-14"><?php echo e($results['success_count']); ?> questions imported successfully</strong>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-danger mr-12','width' => '20px','height' => '20px']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
                                <div>
                                    <strong class="font-14"><?php echo e(count($results['errors'])); ?> errors found</strong>
                                </div>
                            </div>
                            <div class="mt-12">
                                <?php $__currentLoopData = $results['errors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="font-12 text-dark mb-4">
                                        <strong>Row <?php echo e($error['row']); ?>:</strong> <?php echo e($error['message']); ?>
...
<pre style="margin: 0;"><?php echo e($skill); ?>-questions.zip
├── questions.xlsx
...
<?php endif; ?></pre>
            ...
            <div class="bg-white p-20 rounded-24 mb-24">
                ...
                <p class="font-12 text-gray-500 mb-16">Template for <?php echo e(ucfirst($skill)); ?> questions</p>

                <a href="<?php echo e(route('panel.question_bank.import.template', $skill)); ?>" class="d-flex align-items-center p-12 rounded-12 bg-primary-40 bg-hover-primary-60">
...
<?php endif; ?>
                    ...
                    <span class="font-14 text-dark"><?php echo e(ucfirst($skill)); ?> Template</span>
                </a>
            </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-primary mr-8','width' => '16px','height' => '16px']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php echo $__env->make('design_1.panel.layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/panel/question_bank/import.blade.php ENDPATH**/ ?>