        ...
        <div class="col-12">
            <div class="panel-section-card py-20 px-25 mt-20">
                <div class="d-flex align-items-center justify-content-between">
                    <h2 class="font-20 font-weight-bold"><?php echo e(trans('panel.dictionary_and_flashcard')); ?></h2>
                    <a href="<?php echo e(url('/panel/dictionary/flashcards')); ?>" class="btn btn-primary btn-sm">
                        <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-lin-bookmark-2'); ?>
...
<?php endif; ?>
                        <?php echo e(trans('panel.my_flashcards')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-2','width' => '24px','height' => '24px']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
                    ...
                    <p><?php echo e(trans('panel.dictionary_api_key_required')); ?></p>
                    <hr>
                    <p class="mb-0">
                        <strong><?php echo e(trans('panel.steps_to_configure')); ?>:</strong><br>
                        ...
                        4. <?php echo e(trans('panel.reload_page')); ?>
            ...
            <div class="dictionary-card">
                <h4 class="font-16 font-weight-bold mb-3"><?php echo e(trans('panel.search_word')); ?></h4>
                <div class="search-input-wrapper">
                    <input 
                        type="text" 
                        id="searchInput" 
                        class="search-input" 
                        placeholder="<?php echo e(trans('panel.enter_word_to_search')); ?>"
                        autocomplete="off"
                    >
...
<?php endif; ?>
            ...
            <div id="loadingContainer" class="loading" style="display: none;">
                ...
                <p class="text-gray-500"><?php echo e(trans('panel.searching')); ?>...</p>
            </div>
                ...
                <div class="word-header">
                    <div class="d-flex align-items-center">
                        ...
                        <button class="audio-btn" id="audioBtn" style="display: none;">
                            <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-bul-volume-high'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
                    ...
                    <button class="save-flashcard-btn" id="saveFlashcardBtn">
                        <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-lin-save-2'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
                        <?php echo e(trans('panel.save_to_flashcard')); ?>
...
<script>
        ...
        .then(data => {
            if (data.success) {
                Swal.fire({
                    ...
                    text: '<?php echo e(trans("panel.flashcard_saved_successfully")); ?>',
                    timer: 2000
                });
            }
        })
    ...
    function performSearch() {
        ...
        if (!query) {
            showError('<?php echo e(trans("panel.please_enter_word")); ?>');
            return;
        }
        ...
        fetch(`/panel/dictionary/search-first?q=${encodeURIComponent(query)}&dictionary=english-vietnamese&format=html`)
            ...
            .then(data => {
                ...
                if (data.success && data.data) {
                    ...
                    showError('<?php echo e(trans("panel.word_not_found")); ?>');
                    getSuggestions(query);
                }
            })
            .catch(error => {
                loadingContainer.style.display = 'none';
                showError('<?php echo e(trans("panel.search_error")); ?>: ' + error.message);
            });
    }
    ...
    function displaySuggestions(suggestions) {
        ...
        html += '<strong class="d-block mb-2"><?php echo e(trans("panel.did_you_mean")); ?>:</strong>';
        ...
        fetch(`/panel/dictionary/nearby-entries?entryId=${encodeURIComponent(entryId)}&dictionary=english-vietnamese&max=5`)
            ...
            .then(data => {
                if (data.success && data.data && data.data.length > 0) {
                    ...
                    html += '<div class="definition-title"><?php echo e(trans("panel.related_words")); ?></div>';
