                    ...
                    <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_filters_create')): ?>
                                   <a href="<?php echo e(getAdminPanelUrl()); ?>/filters/create" target="_blank" class="btn btn-primary">
...
<?php endif; ?>
                                       <span class="ml-4 font-12"><?php echo e(trans('admin/main.new')); ?><?php echo e(trans('admin/main.filter')); ?></span>
                                   </a>
                               <?php endif; ?>
...
<?php endif; ?>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_filters_edit')): ?>
                                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/filters/<?php echo e($filter->id); ?>/edit"
...
<?php endif; ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_filters_delete')): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/filters/lists.blade.php ENDPATH**/ ?>