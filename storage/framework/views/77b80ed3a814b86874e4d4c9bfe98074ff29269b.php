...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.user_group_discount_rate_hint')); ?></div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.user_group_commission_rate_hint')); ?></div>
                </div>
                ...
                <?php $__currentLoopData = \App\Models\UserCommission::$sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commissionSource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-gray-500 text-small mt-1"><?php echo e(trans("update.{$commissionSource}_commission_hint")); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/users/groups/tabs/general.blade.php ENDPATH**/ ?>