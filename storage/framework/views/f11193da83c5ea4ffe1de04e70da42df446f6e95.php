    ...
    <div class="col-12 col-lg-4">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.total_noticeboards')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($totalNoticeboards); ?></h5>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-4 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.course_notices')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($totalCourseNotices); ?></h5>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-4 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.general_notices')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($totalGeneralNotices); ?></h5>
        </div>
    </div>

</div>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/noticeboard/lists/top_stats.blade.php ENDPATH**/ ?>