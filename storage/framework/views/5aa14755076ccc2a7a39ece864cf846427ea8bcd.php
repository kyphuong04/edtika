    ...
    <div class="d-flex align-items-center justify-content-between " role="tab" id="session_<?php echo e(!empty($session) ? $session->id :'record'); ?>">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($session)): ?>
                <button type="button" data-item-id="<?php echo e($session->id); ?>" data-item-type="<?php echo e(\App\Models\WebinarChapterItem::$chapterSession); ?>" data-chapter-id="<?php echo e(!empty($chapter) ? $chapter->id : ''); ?>" class="js-change-content-chapter btn btn-sm btn-transparent text-gray-500 mr-10">
            ...
            <?php if(!empty($session)): ?>
                <a href="<?php echo e(getAdminPanelUrl()); ?>/sessions/<?php echo e($session->id); ?>/delete" class="delete-action btn btn-sm btn-transparent text-gray-500">
        ...
        <div class="panel-collapse text-gray-500">
            <div class="js-content-form session-form" data-action="<?php echo e(getAdminPanelUrl()); ?>/sessions/<?php echo e(!empty($session) ? $session->id . '/update' : 'store'); ?>">
                ...
                <div class="mt-6 d-flex align-items-center">
                    <button type="button" class="js-save-session btn btn-sm btn-primary size-100"><?php echo e(trans('public.save')); ?></button>

                    <?php if(!empty($session)): ?>
                        <?php if(!$session->isFinished()): ?>
                            <a href="<?php echo e($session->getJoinLink(true)); ?>" target="_blank" class="ml-10 btn btn-sm btn-secondary size-100"><?php echo e(trans('footer.join')); ?></a>
                        <?php else: ?>
                            <button type="button" class="js-session-has-ended ml-10 btn btn-sm btn-secondary disabled size-100"><?php echo e(trans('footer.join')); ?></button>
                        <?php endif; ?>
                    <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/create_includes/accordions/session.blade.php ENDPATH**/ ?>