...
<?php $__env->startSection('content'); ?>
    <form id="quizHoldingForm" action="/panel/quizzes/<?php echo e($quiz->id); ?>/store-result" method="post" class="">
        <?php echo e(csrf_field()); ?>

        <input type="hidden" name="quiz_result_id" value="<?php echo e($newQuizStart->id); ?>" class="form-control" placeholder=""/>
        <input type="hidden" name="attempt_number" value="<?php echo e($attemptCount); ?>" class="form-control" placeholder=""/>
        ...
        <div class="container mt-160 pb-120">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <?php echo $__env->make('design_1.panel.quizzes.holding.start.top_info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="quiz-content-card bg-white rounded-32 p-16 mt-20">
                        ...
                        <div class="position-relative d-flex align-items-center justify-content-between">
                            ...
                            <?php if(!empty($quiz->time)): ?>
                                <div class="d-flex align-items-center timer ltr font-14 font-weight-bold text-dark" data-minutes-left="<?php echo e($quiz->time); ?>"></div>
                            <?php else: ?>
                                <div class="font-14 font-weight-bold text-dark"><?php echo e(trans('quiz.unlimited')); ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php echo $__env->make('design_1.panel.quizzes.holding.start.questions_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('design_1.web.layouts.app', ['appFooter' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/quizzes/holding/start/index.blade.php ENDPATH**/ ?>