        ...
        <div class="header-content">
            <div class="header-text">
                <div class="breadcrumb-modern">
                    <a href="<?php echo e(route('panel.my_ielts_tests.index')); ?>" class="breadcrumb-link">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('panel.my_ielts_tests.index')); ?>" class="btn-modern btn-secondary">
            ...
            <div class="card-body-modern">
                ...
                <div class="skills-content">
                    ...
                    <div class="skill-content active" data-skill-content="listening">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $allListening; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <label class="question-group-card" data-skill-type="listening">
                                <input type="checkbox" name="group_ids[]" value="<?php echo e($group->id); ?>" class="group-checkbox">
                                <div class="group-card-content">
                                    ...
                                    <div class="group-meta">
                                        <span class="group-badge badge-<?php echo e($group->bank_type === 'mock' ? 'primary' : 'success'); ?>">
                                            <?php echo e($group->bank_type_label); ?>
                    ...
                    <div class="skill-content" data-skill-content="reading">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $allReading; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="skill-content" data-skill-content="writing">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $allWriting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="skill-content" data-skill-content="speaking">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $allSpeaking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
