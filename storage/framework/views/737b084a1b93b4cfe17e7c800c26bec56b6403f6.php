    ...
    <div class="d-flex align-items-center justify-content-between " role="tab" id="quiz_<?php echo e(!empty($quizInfo) ? $quizInfo->id :'record'); ?>">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($quizInfo) and !empty($chapterItem)): ?>
                <button type="button" data-item-id="<?php echo e($quizInfo->id); ?>" data-item-type="<?php echo e(\App\Models\WebinarChapterItem::$chapterQuiz); ?>" data-chapter-id="<?php echo e(!empty($chapter) ? $chapter->id : ''); ?>" class="js-change-content-chapter btn btn-sm btn-transparent text-gray-500 mr-10">
            ...
            <?php if(!empty($quizInfo)): ?>
                <a href="<?php echo e(getAdminPanelUrl()); ?>/quizzes/<?php echo e($quizInfo->id); ?>/delete" class="delete-action btn btn-sm btn-transparent text-gray-500">
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/create_includes/accordions/quiz.blade.php ENDPATH**/ ?>