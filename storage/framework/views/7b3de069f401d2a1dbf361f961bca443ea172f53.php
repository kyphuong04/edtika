...
<?php if($allowInstructorDeleteContent): ?>
    ...
    <?php else: ?>
        <a href="<?php echo e($deleteContentUrl); ?>" data-item="<?php echo e($deleteContentItem->id); ?>" data-item-type="<?php echo e($deleteContentItemType); ?>"
           class="js-content-delete-action <?php echo e(!empty($deleteContentClassName) ? $deleteContentClassName : ''); ?>"
        ><?php echo e(trans('public.delete')); ?></a>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/includes/content_delete_btn.blade.php ENDPATH**/ ?>