    ...
    <div class="section-body">
        <div class="row">
            <div class="col-lg-8">
                ...
                <form action="<?php echo e(route('admin.ielts_tests.settings.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="setting-row">
                                ...
                                <div class="setting-control">
                                    <input type="number" 
                                           ...
                                           class="number-input" 
                                           value="<?php echo e($settings['mock_tests_per_day'] ?? 2); ?>" 
                                           min="1" 
                                           max="10">
                                </div>
                            </div>
                                ...
                                <div class="setting-control">
                                    <label class="toggle-switch">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               <?php echo e(($settings['mock_requires_4_skills'] ?? true) ? 'checked' : ''); ?>>
                                ...
                                <div class="setting-control">
                                    <label class="toggle-switch">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               <?php echo e(($settings['practice_unlimited'] ?? true) ? 'checked' : ''); ?>>
                                        <span class="toggle-slider"></span>
                                    </label>
                                </div>
                            </div>
                ...
                <div class="settings-card">
                    ...
                    <div class="settings-card-body">
                        ...
                        <div class="d-flex justify-content-between py-3 border-bottom">
                            ...
                            <strong class="text-primary"><?php echo e($totalMockTests); ?></strong>
                        </div>
                        <div class="d-flex justify-content-between py-3 border-bottom">
                            <span class="text-gray-600">Published Practice Tests</span>
                            <strong class="text-success"><?php echo e($totalPracticeTests); ?></strong>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/ielts_tests/settings.blade.php ENDPATH**/ ?>