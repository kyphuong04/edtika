...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(trans('admin/main.organizations_list')); ?></h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#"><?php echo e(trans('admin/main.organizations_list')); ?></a></div>
                ...
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.total_organizations')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalOrganizations); ?></h5>
                    </div>
                </div>
            </div> 
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.verified_organizations')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($verifiedOrganizations); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.organizations_instructors')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalOrganizationsTeachers); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
    ...
    <div class="card">
         ...
         <div class="card-header justify-content-between">
                            ...
                            <div>
                               ...
                               <p class="font-12 mt-4 mb-0 text-gray-500"><?php echo e(trans('update.manage_all_organizations_in_a_single_place')); ?></p>
                           </div>
                           
                            <div class="d-flex align-items-center gap-12">

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_export_excel')): ?>
                                   <a href="<?php echo e(getAdminPanelUrl()); ?>/organizations/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
                                       <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="table-responsive text-center">
                <table class="table custom-table font-14">
                    <tr>
                        ...
                        <th><?php echo e(trans('admin/main.instructors')); ?></th>
                        <th><?php echo e(trans('admin/main.students')); ?></th>
                        ...
                        <tr>
                                    ...
                                    <div class="position-relative">
                                        <figure class="avatar mr-2" style="position: relative;">
                                            ...
                                            <?php if($user->verified): ?>
                                                <div style="position: absolute; right: 1px; top: 1px; width: 12px; height: 12px; background-color: #3498db; border-radius: 50%; display: flex; align-items: center; justify-content: center; z-index: 1;" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.verified_organization')); ?>">
                            ...
                            <td>
                                <div class="media-body">
                                    <div class="mt-0 mb-1"><?php echo e($user->classesSalesCount); ?></div>
                                    <div class="text-small font-12 text-gray-500"><?php echo e(handlePrice($user->classesSalesSum)); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="mt-0 mb-1"><?php echo e($user->meetingsSalesCount); ?></div>
                                    <div class="text-small font-12 text-gray-500"><?php echo e(handlePrice($user->meetingsSalesSum)); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="mt-0 mb-1"><?php echo e($user->classesPurchasedsCount); ?></div>
                                    <div class="text-small font-12 text-gray-500"><?php echo e(handlePrice($user->classesPurchasedsSum)); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="mt-0 mb-1"><?php echo e($user->meetingsPurchasedsCount); ?></div>
                                    <div class="text-small font-12 text-gray-500"><?php echo e(handlePrice($user->meetingsPurchasedsSum)); ?></div>
                                </div>
                            </td>
                            <td class="mt-0 mb-1"><?php echo e($user->getOrganizationTeachers()->count()); ?></td>
                            <td class="mt-0 mb-1"><?php echo e($user->getOrganizationStudents()->count()); ?></td>
                            ...
                            <td>
                                <div class="media-body">
                                    ...
                                    <span class="badge-status text-danger bg-danger-30"><?php echo e(trans('admin/main.ban')); ?></span>
                                        <div class="text-small font-12 text-gray-500">Until <?php echo e(dateTimeFormat($user->ban_end_at, 'j M Y')); ?></div>
                                    <?php else: ?>
    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e(trans('admin/main.organizations_hint_title_1')); ?></div>
                        <div class=" text-small font-600-bold"><?php echo e(trans('admin/main.organizations_hint_description_1')); ?></div>
                    </div>
                </div>

                <div class="col-md-4">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e(trans('admin/main.organizations_hint_title_2')); ?></div>
                        <div class=" text-small font-600-bold"><?php echo e(trans('admin/main.organizations_hint_description_2')); ?></div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e(trans('admin/main.organizations_hint_title_3')); ?></div>
                        <div class="text-small font-600-bold"><?php echo e(trans('admin/main.organizations_hint_description_3')); ?></div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/users/organizations.blade.php ENDPATH**/ ?>