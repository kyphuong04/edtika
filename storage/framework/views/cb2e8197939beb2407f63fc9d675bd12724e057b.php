...
unset($__errorArgs, $__bag); ?>
                                            <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.new_page_link_hint')); ?></div>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <label><?php echo e(trans('admin/main.subtitle')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(!empty($page) ? $page->subtitle : old('subtitle')); ?>" placeholder="<?php echo e(trans('admin/main.pages_subtitle_placeholder')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="icon" id="icon" value="<?php echo e(!empty($page) ? $page->icon : old('icon')); ?>" class="form-control <?php $__errorArgs = ['icon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="cover" id="cover" value="<?php echo e(!empty($page) ? $page->cover : old('cover')); ?>" class="form-control <?php $__errorArgs = ['cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                                ...
                                                <div class="invalid-feedback"><?php $__errorArgs = ['cover'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></div>
                                        ...
                                        <div class="form-group mt-15">
                                            <label class="input-label"><?php echo e(trans('update.header_icon')); ?></label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" name="header_icon" id="header_icon" value="<?php echo e(!empty($page) ? $page->header_icon : old('header_icon')); ?>" class="form-control <?php $__errorArgs = ['header_icon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/pages/create.blade.php ENDPATH**/ ?>