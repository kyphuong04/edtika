...
<head>
    ...
    <title>IELTS <?php echo e(ucfirst($currentSection->skill ?? 'Test')); ?></title>
...
<body>
    ...
    <div class="idp-part-bar">
        <span class="idp-part-title">Part <?php echo e($partNum); ?></span>
        <span class="idp-part-instruction">
            <?php if($skill === 'reading'): ?>
                Read the text and answer questions <a href="#"><?php echo e($qStart); ?>-<?php echo e($qEnd); ?></a>.
            <?php elseif($skill === 'listening'): ?>
                Listen and answer questions <?php echo e($qStart); ?>-<?php echo e($qEnd); ?>.
    ...
    <main class="idp-main">
        <?php if($skill === 'speaking'): ?>
            
            <?php echo $__env->make('design_1.panel.ielts_tests.partials.idp_speaking_complete', [
        ...
        <?php elseif($skill === 'writing'): ?>
            ...
            <?php echo $__env->make('design_1.panel.ielts_tests.partials.idp_writing_complete', [
                'section' => $currentSection,
                'question' => $firstQ,
                'userAnswer' => $userAnswers[$firstQ->id ?? 0] ?? ''
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php elseif($skill === 'listening' && empty($currentSection->passage_text)): ?>
            
            <div class="idp-right" style="flex: none; width: 100%;">
                <?php echo $__env->make('design_1.panel.ielts_tests.partials.idp_questions_panel', [
        ...
        <?php else: ?>
            ...
            <div class="idp-left" id="leftPanel">
                <?php if(!empty($currentSection->passage_title)): ?>
                    <h2 class="idp-passage-title"><?php echo e($currentSection->passage_title); ?></h2>
                <?php endif; ?>
                <?php if(!empty($currentSection->subtitle)): ?>
                    <p class="idp-passage-note"><?php echo e($currentSection->subtitle); ?></p>
                <?php endif; ?>
                <div class="idp-passage-text">
                    <?php echo $currentSection->passage_text ?? $currentSection->content ?? ''; ?>
    ...
    <footer class="idp-footer">
        <div class="idp-parts-nav">
            <?php $__currentLoopData = $partsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pNum => $pInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="idp-part-group">
                    <span class="idp-part-label <?php echo e($pNum == $partNum ? 'active' : ''); ?>">Part <?php echo e($pNum); ?></span>
                    <div class="idp-q-nums">
                        <?php $__currentLoopData = $pInfo['questions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="idp-q-num-footer"><?php echo e($qn); ?></span>
    ...
    <?php if($skill === 'listening'): ?>
        ...
        <audio id="audioPlayer" src="<?php echo e($currentSection->audio_url ?? ''); ?>"></audio>
    <?php endif; ?>
    ...
    <script>
        ...
        const saveUrl = '<?php echo e(route("panel.ielts_tests.save_answer", $attempt->id)); ?>';
        const submitUrl = '<?php echo e(route("panel.ielts_tests.finish_section", $attempt->id)); ?>';
...
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/panel/ielts_tests/take_idp.blade.php ENDPATH**/ ?>