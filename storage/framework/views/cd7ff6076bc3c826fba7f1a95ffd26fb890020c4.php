...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('update.username')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(!empty($user) ? $user->username : old('username')); ?>"
                           placeholder="<?php echo e(trans('update.username_input_placeholder')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-muted mt-8 font-12"><?php echo e(trans('update.username_input_placeholder')); ?></div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    ...
                    <div class="text-gray-500 text-small"><?php echo e(trans('update.admin_user_edit_can_create_store_hint')); ?></div>
                </div>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    ...
                    <div class="text-gray-500 text-small"><?php echo e(trans('update.admin_user_edit_content_access_limitation_hint')); ?></div>
                </div>
                ...
                <?php if(!empty($user) and !$user->isUser()): ?>
                    <div class="form-group custom-switches-stacked mt-2">
                        ...
                        <div class="text-gray-500 text-small"><?php echo e(trans('update.admin_user_edit_enable_ai_content_hint')); ?></div>
                    </div>
                <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/users/editTabs/general.blade.php ENDPATH**/ ?>