...
<?php endif; ?>
                        ...
                        <h1 class="font-24 font-weight-bold mt-12"><?php echo e($pageTitle); ?></h1>
                        <div class="font-12 text-gray-500 mt-8"><?php echo e(trans('update.all_thing_about')); ?></div>
                    </div>

                    <?php if(!empty($pageOverlayImage)): ?>
                        <div class="courses-lists-header__overlay-img">
                            <img src="<?php echo e($pageOverlayImage); ?>" alt="<?php echo e($pageTitle); ?>" class="img-cover">
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make("design_1.web.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/web/courses/lists/classes.blade.php ENDPATH**/ ?>