            ...
            <div class="card">
                ...
                <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                               ...
                               <a href="<?php echo e(getAdminPanelUrl()); ?>/<?php echo e((!empty($isCourseNotice) and $isCourseNotice) ? 'course-noticeboards' : 'noticeboards'); ?>/send" class="btn btn-primary">
...
<?php endif; ?>
                                       <span class="ml-4 font-12"><?php echo e(trans('admin/main.send_noticeboard')); ?></span>
                                   </a>
                               <?php endif; ?>
                                    ...
                                    <?php if(!empty($isCourseNotice) and !empty($noticeboard->webinar)): ?>
                                        <td class="text-dark text-left">
                                            <?php if(!empty($noticeboard->webinar)): ?>
                                                <a href="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e($noticeboard->webinar->id); ?>/edit" target="_blank" class="text-dark font-14 d-block"><?php echo e($noticeboard->webinar->id); ?>-<?php echo e(truncate($noticeboard->webinar->title,32)); ?></a>
                                            <?php endif; ?>
                                        </td>
                                    <?php endif; ?>
...
<?php endif; ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_noticeboards_edit')): ?>
                                                            <a href="<?php echo e(getAdminPanelUrl()); ?>/<?php echo e((!empty($isCourseNotice) and $isCourseNotice) ? 'course-noticeboards' : 'noticeboards'); ?>/<?php echo e($noticeboard->id); ?>/edit" class="dropdown-item d-flex align-items-center mb-3 py-3 px-0 gap-4">
                                                            <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                            ...
                                            <?php if(!empty($isCourseNotice)): ?>
                                                <?php echo $__env->make('admin.includes.delete_button',[
                                                           'url' => getAdminPanelUrl().'/course-noticeboards/'.$noticeboard->id.'/delete',
                                            ...
                                            <?php else: ?>
                                                <?php echo $__env->make('admin.includes.delete_button',[
                                                           'url' => getAdminPanelUrl().'/noticeboards/'.$noticeboard->id.'/delete',
                                                           'btnClass' => 'dropdown-item text-danger mb-0 py-3 px-0 font-14',
                                                           'btnText' => trans("admin/main.delete"),
                                                           'btnIcon' => 'trash',
                                                           'iconType' => 'lin',
...
<?php $__env->startPush('scripts_bottom'); ?>
    <script src="/assets/admin/js/parts/noticeboards.min.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/noticeboards/lists.blade.php ENDPATH**/ ?>