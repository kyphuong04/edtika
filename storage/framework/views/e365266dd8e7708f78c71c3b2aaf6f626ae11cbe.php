...
<div class="sidebar-content-item d-flex align-items-center justify-content-between mb-12 p-12 rounded-16 cursor-pointer js-content-tab-item <?php echo e($hasSequenceContentError ? 'js-sequence-content-error-modal' : ''); ?>"
...
>
    <div class="d-flex align-items-center">
        <div class="position-relative d-flex-center size-48 rounded-12 bg-gray-200">
            ...
            <?php echo e(svg("iconsax-bul-{$fileIcon}", ['height' => 24, 'width' => 24, 'class' => 'text-gray-500'])); ?>
...
<?php endif; ?>
        ...
        <div class="ml-8">
            <span class=" d-block font-weight-bold font-14 text-dark"><?php echo e(truncate($file->title, 27)); ?></span>
            <span class=" d-block font-12 text-gray-500 mt-4"><?php echo e(trans('update.file_type_' . $file->file_type)); ?></span>
        </div>
    </div>
...
<?php endif; ?>
        ...
        <?php if(!empty($file->checkPassedItem())): ?>
            <div class="">
                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/web/courses/learning_page/includes/sidebar/tabs/contents/file.blade.php ENDPATH**/ ?>