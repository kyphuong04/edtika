<?php $__currentLoopData = \App\Mixins\Panel\SidebarItems::getItems(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebarSection => $sidebarMenus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(!empty($sidebarMenus) and count($sidebarMenus)): ?>
        <div class="mt-16">
            <span class="d-block font-12 font-weight-bold text-gray-400 text-uppercase pl-32 pr-20 mb-8 sidebar-section-title"><?php echo e(trans("update.{$sidebarSection}")); ?></span>
            ...
            <?php $__currentLoopData = $sidebarMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebarMenuName => $sidebarMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(!empty($sidebarMenu['items'])): ?>
                    <div class="accordion ">
                        <div class="panel-sidebar__menu accordion__title d-flex align-items-center pl-32 pr-20 <?php echo e(($isActiveMainManu) ? 'sidenav-item-active' : ''); ?>" href="#collapseSidebar<?php echo e($sidebarMenuName); ?>" data-parent="#sidebarAccordions" role="button" data-toggle="collapse" title="<?php echo e($sidebarMenu['text']); ?>">
                            <span class="sidebar-icon <?php echo e($isActiveMainManu ? 'text-primary' : 'text-gray-500'); ?>"><?php echo $sidebarMenu['icon']; ?></span>
                            <span class="ml-8 font-14 sidebar-text <?php echo e($isActiveMainManu ? 'text-primary' : 'text-dark'); ?>"><?php echo e($sidebarMenu['text']); ?></span>

                            <span class="collapse-arrow-icon d-flex cursor-pointer ml-auto" href="#collapseSidebar<?php echo e($sidebarMenuName); ?>" data-parent="#sidebarAccordions" role="button" data-toggle="collapse">
...
<?php endif; ?>
                        ...
                        <div id="collapseSidebar<?php echo e($sidebarMenuName); ?>" class="accordion__collapse border-top-0 pt-0 mt-0 <?php echo e($isActiveMainManu ? 'show' : ''); ?>" role="tabpanel">
                            ...
                            <?php $__currentLoopData = $sidebarMenu['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebarMenuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e($sidebarMenuItem['url']); ?>" class="d-flex align-items-center panel-sidebar__menu-item text-gray-500 font-14 pl-32 pr-20 <?php echo e(($isActiveItemManu) ? 'text-primary' : ''); ?>" title="<?php echo e($sidebarMenuItem['text']); ?>">
                ...
                <?php else: ?>
                    <a href="<?php echo e($sidebarMenu['url']); ?>" class="panel-sidebar__menu d-flex align-items-center pl-32 pr-20 <?php echo e(($isActiveMainManu) ? 'sidenav-item-active' : ''); ?>" title="<?php echo e($sidebarMenu['text']); ?>">
                        ...
                        <span class="ml-8 font-14 sidebar-text <?php echo e($isActiveMainManu ? 'text-primary' : (!empty($sidebarMenu['className']) ? $sidebarMenu['className'] : 'text-dark')); ?>"><?php echo e($sidebarMenu['text']); ?></span>
                    </a>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/includes/sidebar/items.blade.php ENDPATH**/ ?>