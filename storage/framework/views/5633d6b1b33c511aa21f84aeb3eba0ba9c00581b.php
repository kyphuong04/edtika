    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="<?php echo e(getAdminPanelUrl("/settings/update-app/database")); ?>" method="post">
                ...
                <p class="text-gray-500 font-12"><?php echo e(trans('update.database_update_hint')); ?></p>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/settings/update_app/database_tab.blade.php ENDPATH**/ ?>