...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <button type="submit" class="btn text-end btn-primary"><?php echo e(trans('admin/main.submit')); ?></button>
                                                    </form>
                                                </div>
                                            </div>
...
<?php endif; ?>
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_badges_edit')): ?>
                <a href="<?php echo e(getAdminPanelUrl()); ?>/users/badges/<?php echo e($badge->id); ?>/edit"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/users/badges.blade.php ENDPATH**/ ?>