                ...
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.total_instructors')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalInstructors); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalOrganizationsInstructors); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.inactive_instructors')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($inactiveInstructors); ?></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8"><?php echo e(trans('admin/main.ban_instructors')); ?></span>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($banInstructors); ?></h5>
                    </div>
                </div>
            </div>
        </div>
             ...
             <div class="card">
                ...
                <div class="card-header justify-content-between">
                            ...
                            <div>
                               ...
                               <p class="font-12 mt-4 mb-0 text-gray-500"><?php echo e(trans('update.manage_all_instructors_in_a_single_place')); ?></p>
                           </div>
                           
                            <div class="d-flex align-items-center gap-12">

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_export_excel')): ?>
                                   <a href="<?php echo e(getAdminPanelUrl()); ?>/instructors/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
                                       <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                            ...
                            <td>
                                <div class="media-body">
                                    ...
                                    <span class="badge-status text-danger bg-danger-30"><?php echo e(trans('admin/main.ban')); ?></span>
                                        <div class="text-small font-12 text-gray-500"><?php echo e(trans('admin/main.until')); ?> <?php echo e(dateTimeFormat($user->ban_end_at, 'j M Y')); ?></div>
                                    <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/users/instructors.blade.php ENDPATH**/ ?>