...
<?php endif; ?>
        ...
        <?php if(!empty($unReadNotifications) and count($unReadNotifications)): ?>
            <span class="admin-header__badge-counter badge-counter"><?php echo e(count($unReadNotifications)); ?></span>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
                    ...
                    <div class="ml-8">
                        ...
                        <a href="<?php echo e(getAdminPanelUrl("/notifications/mark_all_read")); ?>" class="delete-action d-block mt-4 font-12 cursor-pointer text-gray-500" data-title="<?php echo e(trans('update.convert_unread_messages_to_read')); ?>" data-confirm="<?php echo e(trans('update.yes_convert')); ?>">
            ...
            <?php $__currentLoopData = $unReadNotifications->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unReadNotification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(getAdminPanelUrl("/notifications?notification={$unReadNotification->id}")); ?>" class="language-dropdown__item  d-flex align-items-center w-100 px-16 py-8 text-dark bg-transparent">
                    <div class="">
                        <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="px-12">
                <a href="<?php echo e(getAdminPanelUrl("/notifications")); ?>" class="btn btn-lg btn-primary btn-block mt-12"><?php echo e(trans('notification.all_notifications')); ?></a>
            </div>
        <?php else: ?>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/includes/header/notification.blade.php ENDPATH**/ ?>