    ...
    <div class="custom-modal-body">
        ...
        <div class="quiz-questions-form" data-action="<?php echo e(getAdminPanelUrl()); ?>/quizzes-questions/<?php echo e(empty($question_edit) ? 'store' : $question_edit->id.'/update'); ?>" method="post">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label class="input-label"><?php echo e(trans('update.negative_grade')); ?></label>
            ...
            <div class="mt-3">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <button type="button" class="btn btn-sm btn-primary mt-16 add-answer-btn"><?php echo e(trans('quiz.add_an_answer')); ?></button>
            ...
            <div class="add-answer-container">
                ...
                <?php if(!empty($question_edit->quizzesQuestionsAnswers) and !$question_edit->quizzesQuestionsAnswers->isEmpty()): ?>
                    <?php $__currentLoopData = $question_edit->quizzesQuestionsAnswers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answerRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('admin.quizzes.modals.multiple_answer_form', ['answer' => $answerRow], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/quizzes/modals/multiple_question.blade.php ENDPATH**/ ?>