                    ...
                    <div class="card-statistic">
                        ...
                        <div class="card-statistic__wrap">
                            <div class="d-flex align-items-start justify-content-between">
                                <span class="text-gray-500 mt-8"><?php echo e(trans('update.total_forums')); ?></span>
...
<?php endif; ?>
                            ...
                            <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalForums); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card-statistic">
                        ...
                        <div class="card-statistic__wrap">
                            <div class="d-flex align-items-start justify-content-between">
                                <span class="text-gray-500 mt-8"><?php echo e(trans('update.total_topics')); ?></span>
                                <div class="d-flex-center size-48 bg-secondary-30 rounded-12">
                                    <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('iconsax-bul-message-square'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'icons text-secomndary','width' => '24px','height' => '24px']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e)): ?>
<?php $component = $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e; ?>
...
<?php endif; ?>
                            ...
                            <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalTopics); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card-statistic">
                        ...
                        <div class="card-statistic__wrap">
                            <div class="d-flex align-items-start justify-content-between">
                                <span class="text-gray-500 mt-8"><?php echo e(trans('update.total_posts')); ?></span>
...
<?php endif; ?>
                            ...
                            <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($postsCount); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card-statistic">
                        ...
                        <div class="card-statistic__wrap">
                            <div class="d-flex align-items-start justify-content-between">
                                <span class="text-gray-500 mt-8"><?php echo e(trans('update.active_members')); ?></span>
...
<?php endif; ?>
                            ...
                            <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($membersCount); ?></h5>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-12">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_forum_create')): ?>
                                   <a href="<?php echo e(getAdminPanelUrl("/forums/create")); ?>" target="_blank" class="btn btn-primary">
                                       <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left text-dark">
                                                <?php if(!empty($forum->subForums) and count($forum->subForums)): ?>
                                                    <a class="text-dark" href="<?php echo e(getAdminPanelUrl()); ?>/forums?subForums=<?php echo e($forum->id); ?>"><?php echo e($forum->title); ?></a>
                                                <?php else: ?>
                                                    <a class="text-dark" href="<?php echo e(getAdminPanelUrl()); ?>/forums/<?php echo e($forum->id); ?>/topics"><?php echo e($forum->title); ?></a>
                                                <?php endif; ?>
                                            </td>
                                            <?php if(empty(request()->get('subForums'))): ?>
                                                <td>
                                            ...
                                            <td>
                                            <span class="badge-status <?php echo e(($forum->status == 'active') ? 'text-success bg-success-30' : 'text-danger bg-danger-30'); ?>"><?php echo e(trans('admin/main.'.$forum->status)); ?></span>
                                            </td>
                                            <td>
                                                <?php if($forum->close): ?>
...
<?php endif; ?>
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <?php if(!empty($forum->subForums) && count($forum->subForums)): ?>
...
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
                    <span class="text-gray-500 font-14"><?php echo e(trans('update.forums')); ?></span>
                </a>
            <?php else: ?>
...
<?php unset($__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e); ?>
<?php endif; ?>
                        <span class="text-gray-500 font-14"><?php echo e(trans('update.topics')); ?></span>
                    </a>
                <?php endif; ?>
            <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/forums/lists.blade.php ENDPATH**/ ?>