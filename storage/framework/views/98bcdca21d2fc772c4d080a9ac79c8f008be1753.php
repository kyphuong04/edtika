...
<?php endif; ?>
        ...
        <div class="ml-8">
            <span class=" d-block font-weight-bold font-14 text-dark"><?php echo e(truncate($quiz->title, 27)); ?></span>
            <span class=" d-block font-12 text-gray-500 mt-4"><?php echo e(trans('public.quiz')); ?></span>
        </div>
    </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/web/courses/learning_page/includes/sidebar/tabs/contents/quiz.blade.php ENDPATH**/ ?>