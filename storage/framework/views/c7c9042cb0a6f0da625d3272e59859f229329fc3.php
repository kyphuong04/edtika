        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group custom-switches-stacked">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.device_limit_hint')); ?></div>
                </div>
                ...
                <div class="js-device-limit-number <?php echo e((!empty($itemValue) and !empty($itemValue['login_device_limit']) and $itemValue['login_device_limit']) ? '' : 'd-none'); ?>">
                    <div class="form-group">
                        ...
                        <input type="number" name="value[number_of_allowed_devices]" id="number_of_allowed_devices"
                               ...
                               class="form-control"/>
                        <p class="font-12 text-gray-500 mt-1 mb-0"><?php echo e(trans('update.number_of_allowed_devices_hint')); ?></p>
                    </div>
                ...
                <?php $__currentLoopData = $captchaSwitchs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $captchaSwitch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group custom-switches-stacked">
                        ...
                        <div class="text-gray-500 text-small"><?php echo e(trans('update.'.$captchaSwitch.'_hint')); ?></div>
                    </div>
                ...
                <div class="form-group mt-2">
                    ...
                    <p class="font-12 text-gray-500 mt-1 mb-0"><?php echo e(trans('update.admin_panel_url_hint')); ?></p>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/settings/general/security.blade.php ENDPATH**/ ?>