                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card border-primary h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="<?php echo e(route('panel.question_bank.import', ['skill' => 'listening'])); ?>" class="btn btn-primary btn-lg">
                                                <i class="fas fa-upload"></i> Import Listening
                                            </a>
                                            <a href="<?php echo e(route('panel.question_bank.import.template', ['skill' => 'listening'])); ?>" class="btn btn-outline-secondary btn-sm mt-2">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card border-success h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="<?php echo e(route('panel.question_bank.import', ['skill' => 'reading'])); ?>" class="btn btn-success btn-lg">
                                                <i class="fas fa-upload"></i> Import Reading
                                            </a>
                                            <a href="<?php echo e(route('panel.question_bank.import.template', ['skill' => 'reading'])); ?>" class="btn btn-outline-secondary btn-sm mt-2">
                                                <i class="fas fa-download"></i> Download Template
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card border-warning h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="<?php echo e(route('panel.question_bank.import', ['skill' => 'writing'])); ?>" class="btn btn-warning btn-lg">
                                                <i class="fas fa-upload"></i> Import Writing
                                            </a>
                                            <a href="<?php echo e(route('panel.question_bank.import.template', ['skill' => 'writing'])); ?>" class="btn btn-outline-secondary btn-sm mt-2">
                                                <i class="fas fa-download"></i> Download Template
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card border-danger h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="<?php echo e(route('panel.question_bank.import', ['skill' => 'speaking'])); ?>" class="btn btn-danger btn-lg">
                                                <i class="fas fa-upload"></i> Import Speaking
                                            </a>
                                            <a href="<?php echo e(route('panel.question_bank.import.template', ['skill' => 'speaking'])); ?>" class="btn btn-outline-secondary btn-sm mt-2">
                                                <i class="fas fa-download"></i> Download Template
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center">
                                <a href="<?php echo e(route('panel.question_bank')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make(getTemplate().'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/question_bank/import_select_skill.blade.php ENDPATH**/ ?>