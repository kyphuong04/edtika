    ...
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.bundles')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e(!empty($bundles) ? $bundlesCount : 0); ?></h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('home.hours')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e(convertMinutesToHourAndMinute($bundlesHours)); ?></h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.bundle_sales_count')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e($bundleSalesCount); ?></h5>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3 mt-16 mt-md-0">
        <div class="bg-white p-16 rounded-24">
            <div class="d-flex align-items-start justify-content-between">
                <span class="text-gray-500 mt-8"><?php echo e(trans('update.bundle_sales')); ?></span>
...
<?php endif; ?>
            ...
            <h5 class="font-24 mt-12 line-height-1"><?php echo e(handlePrice($bundleSalesAmount)); ?></h5>
        </div>
    </div>

</div>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/bundles/my_bundles/top_stats.blade.php ENDPATH**/ ?>