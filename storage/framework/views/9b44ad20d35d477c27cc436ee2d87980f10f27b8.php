<div class="instructor-dashboard__hello-box <?php echo e($authUser->isOrganization() ? 'organ-hello-box' : ''); ?> p-16 rounded-24 mt-54 w-100">
...
<?php endif; ?>
        ...
        <div class="col-12 col-lg-6 position-relative d-none d-lg-block">
            <div class="hello-box-user-vector d-flex justify-content-end">
                <img src="/assets/design_1/img/panel/dashboard/<?php echo e($authUser->isOrganization() ? 'organ' : 'instructor'); ?>/hello-box-user-vector.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
