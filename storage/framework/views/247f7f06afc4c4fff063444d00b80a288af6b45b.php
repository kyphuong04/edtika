    ...
    <div class="d-flex flex-wrap align-items-center gap-20 gap-lg-48 px-12 py-10">
        ...
        <div class="form-group d-flex align-items-center mb-0">
            <div class="custom-switch mr-8">
                <input id="available_for_meetings" type="checkbox" name="available_for_meetings" class="custom-control-input" <?php echo e((request()->get('available_for_meetings', null) == 'on') ? 'checked="checked"' : ''); ?>>
                <label class="custom-control-label cursor-pointer" for="available_for_meetings"></label>
            </div>

            <div class="">
                <label class="cursor-pointer" for="available_for_meetings"><?php echo e(trans('public.available_for_meetings')); ?></label>
            </div>
        </div>
        ...
        <div class="form-group d-flex align-items-center mb-0">
            <div class="custom-switch mr-8">
                <input id="free_meetings" type="checkbox" name="free_meetings" class="custom-control-input" <?php echo e((request()->get('free_meetings', null) == 'on') ? 'checked="checked"' : ''); ?>>
                <label class="custom-control-label cursor-pointer" for="free_meetings"></label>
            </div>

            <div class="">
                <label class="cursor-pointer" for="free_meetings"><?php echo e(trans('public.free_meetings')); ?></label>
            </div>
        </div>

        <div class="form-group d-flex align-items-center mb-0">
            <div class="custom-switch mr-8">
                <input id="discount" type="checkbox" name="discount" class="custom-control-input" <?php echo e((request()->get('discount', null) == 'on') ? 'checked="checked"' : ''); ?>>
                <label class="custom-control-label cursor-pointer" for="discount"></label>
            </div>

            <div class="">
                <label class="cursor-pointer" for="discount"><?php echo e(trans('public.discount')); ?></label>
            </div>
        </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/web/instructor_finder/lists/top_filters.blade.php ENDPATH**/ ?>