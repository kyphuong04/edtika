    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <p class="">
                        <span class="font-weight-bold"><?php echo e(trans('admin/main.course_title')); ?></span>:
                        <?php echo e($webinar->title); ?>

                    </p>

                    <form method="post" action="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e($webinar->id); ?>/sendNotification" class="form-horizontal form-bordered mt-4">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/webinars/send-notification-to-course-students.blade.php ENDPATH**/ ?>