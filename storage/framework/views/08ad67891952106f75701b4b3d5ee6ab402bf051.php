...
<?php endif; ?>
        ...
        <span class="font-14 font-weight-bold ml-8"><?php echo e(trans("update.cart")); ?></span>
    </div>

    <div class="cart-drawer__body pb-32" data-simplebar <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
    ...
    <div class="cart-drawer__footer pt-16 border-top-gray-bg d-none px-16">
        ...
        <div class="mt-12">
            <a href="/cart" class="btn btn-outline-primary btn-block"><?php echo e(trans('update.view_cart')); ?></a>
        </div>
    </div>
</div>
<div class="cart-drawer-mask"></div>
<?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/web/cart/drawer/index.blade.php ENDPATH**/ ?>