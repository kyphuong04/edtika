                ...
                <div class="col-12 col-md-12">
                    ...
                    <div class="card-header justify-content-between">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_categories_create')): ?>
                                   <a href="<?php echo e(getAdminPanelUrl()); ?>/categories/create" target="_blank" class="btn btn-primary">
...
<?php endif; ?>
                                       <span class="ml-4 text-small font-small font-12"><?php echo e(trans('admin/main.new')); ?> <?php echo e(trans('admin/main.category')); ?></span>
                                   </a>
                               <?php endif; ?>
...
<?php endif; ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_categories_delete')): ?>
                                                        <?php echo $__env->make('admin.includes.delete_button',[
                                                            'url' => getAdminPanelUrl().'/categories/'.$category->id.'/delete',
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/categories/lists.blade.php ENDPATH**/ ?>