...
unset($__errorArgs, $__bag); ?></div>
            <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.certificate_template_image_hint')); ?></div>
        </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/certificates/create_template/template-form.blade.php ENDPATH**/ ?>