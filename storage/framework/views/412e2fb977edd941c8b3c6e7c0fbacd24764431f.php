...
<div class="page-container mt-30">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-start">
            ...
            <div class="daily-limit-badge">
                <?php if(isset($remainingToday) && $remainingToday > 0): ?>
                    <div class="limit-box success">
                        <i class="fas fa-check-circle"></i>
                        <span>Còn <strong><?php echo e($remainingToday); ?></strong>/<?php echo e($dailyLimit ?? 2); ?> lượt hôm nay</span>
                    </div>
                <?php else: ?>
    ...
    <?php else: ?>
        <?php $__currentLoopData = $mockTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="mock-card">
            <div class="mock-card-header">
                <h2 class="mock-card-title"><?php echo e($test->title); ?></h2>
            ...
            <?php if($test->user_attempts > 0): ?>
            <div class="attempts-info">
                <span>
                    <i class="fas fa-history mr-2"></i>
                    Đã làm <?php echo e($test->user_attempts); ?> lần
                    <?php if($test->best_attempt && $test->best_attempt->overall_band): ?>
                        • Điểm cao nhất: Band <?php echo e($test->best_attempt->overall_band); ?>
            ...
            <div class="skills-grid">
                ...
                <div class="skill-item listening">
                    ...
                    <div class="skill-duration"><?php echo e($test->listening_duration ?? 30); ?> phút</div>
                ...
                <div class="skill-item reading">
                    ...
                    <div class="skill-duration"><?php echo e($test->reading_duration ?? 60); ?> phút</div>
                    <div class="skill-status pending">
                        <i class="far fa-clock"></i> Chờ làm
                    </div>
                </div>
                ...
                <div class="skill-item writing">
                    ...
                    <div class="skill-duration"><?php echo e($test->writing_duration ?? 60); ?> phút</div>
                    <div class="skill-status pending">
                        <i class="far fa-clock"></i> Chờ làm
                    </div>
                </div>
                ...
                <div class="skill-item speaking">
                    ...
                    <div class="skill-duration"><?php echo e($test->speaking_duration ?? 15); ?> phút</div>
                    <div class="skill-status pending">
                        <i class="far fa-clock"></i> Chờ làm
                    </div>
                </div>
            ...
            <div class="full-test-footer">
                <div class="full-test-info">
                    ...
                    <div class="full-test-details">
                        <h4>Full Test</h4>
                        <p><?php echo e($test->total_duration); ?> phút • 4 kỹ năng liên tiếp</p>
                    </div>
                </div>
                <?php if($test->can_take === true): ?>
...
<?php echo $__env->make('design_1.panel.layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/design_1/panel/ielts_tests/mock.blade.php ENDPATH**/ ?>