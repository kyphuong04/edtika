...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('design_1.panel.manage.instructors.top_stats', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(!empty($users) and !$users->isEmpty()): ?>
        <div class="bg-white pt-16 rounded-24 mt-20">
            ...
            <div class="d-flex align-items-center justify-content-between pb-16 px-16 border-bottom-gray-100">
                <div class="">
                    <h3 class="font-16"><?php echo e(trans('panel.instructors_list')); ?></h3>

                </div>
            </div>

            
            <?php echo $__env->make('design_1.panel.manage.instructors.filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div id="tableListContainer" class="table-responsive-lg" data-view-data-path="/panel/manage/instructors">
                <table class="table panel-table">
                    ...
                    <tr>
                        ...
                        <th class="text-center"><?php echo e(trans('panel.sales')); ?></th>
                        <th class="text-center"><?php echo e(trans('panel.sales_amount')); ?></th>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('design_1.panel.manage.instructors.table_items', ['user' => $userRow], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('design_1.panel.layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/panel/manage/instructors/index.blade.php ENDPATH**/ ?>