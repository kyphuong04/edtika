...
<?php if($showOtherRegisterMethod): ?>
    <div class="d-flex align-items-center gap-4 p-4 rounded-12 border-gray-300 mb-28">
        <div class="auth-register-method-item flex-1">
            ...
            <label class="d-flex-center cursor-pointer" for="emailType"><?php echo e(trans('public.email')); ?></label>
        </div>
        ...
        <div class="auth-register-method-item flex-1">
            ...
            <label class="d-flex-center cursor-pointer" for="mobileType"><?php echo e(trans('public.mobile')); ?></label>
        </div>
    </div>

    <div class="js-email-fields form-group <?php echo e((($registerMethod == 'email' and empty(old('type'))) or old('type') == "email") ? '' : 'd-none'); ?>">
        <label class="form-group-label" for="email"><?php echo e(trans('public.email')); ?>:</label>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="js-mobile-fields <?php echo e((($registerMethod == 'mobile' and empty(old('type'))) or old('type') == "mobile") ? '' : 'd-none'); ?>">
        <?php echo $__env->make('design_1.web.auth.theme_1.includes.mobile_field', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
<?php else: ?>
    ...
    <?php else: ?>
        ...
        <?php echo $__env->make('design_1.web.auth.theme_1.includes.email_field', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/design_1/web/auth/theme_1/includes/login_methods.blade.php ENDPATH**/ ?>