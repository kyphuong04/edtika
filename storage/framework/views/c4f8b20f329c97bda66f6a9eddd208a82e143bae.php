...
<div class="tab-pane mt-3 fade <?php if(empty($social)): ?> show active <?php endif; ?>" id="basic" role="tabpanel" aria-labelledby="basic-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="<?php echo e(getAdminPanelUrl()); ?>/settings/general" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.default_language_hint')); ?></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.user_languages_lists_hint')); ?></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('admin/main.rtl_languages_hint')); ?></div>
                </div>
                ...
                <div class="form-group">
                    <label class="input-label"><?php echo e(trans('update.dark_mode_logo')); ?></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" name="value[dark_mode_logo]" id="dark_mode_logo" value="<?php echo e((!empty($itemValue) and !empty($itemValue['dark_mode_logo'])) ? $itemValue['dark_mode_logo'] : old('dark_mode_logo')); ?>" class="form-control" placeholder="<?php echo e(trans('admin/main.logo_placeholder')); ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.multi_language_content_hint')); ?></div>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    ...
                    <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.app_debugbar_hint')); ?></div>
                </div>
...
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/settings/general/basic.blade.php ENDPATH**/ ?>