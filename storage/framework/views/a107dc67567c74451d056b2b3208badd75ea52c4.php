...
<?php if($productBadges->isNotEmpty()): ?>
    <div class="form-group mt-15">
        ...
        <div class="text-gray-500 text-small mt-1"><?php echo e(trans('update.select_badges_hint')); ?></div>
    </div>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\edtika\resources\views/admin/product_badges/content_include.blade.php ENDPATH**/ ?>