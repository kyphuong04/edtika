...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1>Regular Users <?php echo e(trans('admin/main.list')); ?></h1>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalRegularUsers); ?></h5>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($totalOrganizationsRegularUsers); ?></h5>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($inactiveRegularUsers); ?></h5>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black"><?php echo e($banRegularUsers); ?></h5>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="col-md-3 d-flex align-items-center ">
    ...
    <div class="card-header justify-content-between">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_export_excel')): ?>
                                   <a href="<?php echo e(getAdminPanelUrl()); ?>/regular-users/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
                                       <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edtika\resources\views/admin/users/regular_users.blade.php ENDPATH**/ ?>