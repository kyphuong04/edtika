...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'quizzes'], function () {
            ...
            Route::group(['prefix' => '/{id}/results'], function () {
                Route::get('/', 'QuizResultsController@index');
                Route::get('/{result_id}/review', 'QuizResultsController@review');
                Route::post('/{result_id}/update', 'QuizResultsController@update');
                Route::get('/excel', 'QuizResultsController@exportExcel');
                Route::get('/{result_id}/delete', 'QuizResultsController@delete');
            });
        });
