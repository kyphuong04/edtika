    ...
    <div class="col-12">
        ...
        <div class="form-group mt-15 ">
            ...
            <select name="target_type" class="js-target-types-input custom-select @error('target_types')  is-invalid @enderror">
                @foreach(\App\Models\AbandonedCartRule::$targetTypes as $type)
        ...
        <div class="form-group mt-15 js-select-target-field {{ (empty($rule) or $rule->target_type == "all") ? 'd-none' : '' }}">
            <label class="input-label d-block">{{ trans('update.select_target') }}</label>

            @php
                $targets = [
                    'courses' => \App\Models\AbandonedCartRule::$courseTargets,
                    'store_products' => \App\Models\AbandonedCartRule::$productTargets,
                    'bundles' => \App\Models\AbandonedCartRule::$bundleTargets,
                    'meetings' => \App\Models\AbandonedCartRule::$meetingTargets,
                ];
            @endphp
