                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="{{ getAdminPanelUrl() }}/store/discounts/{{ !empty($discount) ? $discount->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="start_date" class="form-control text-center datetimepicker" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="end_date" class="form-control text-center datetimepicker" autocomplete="off"
                                               aria-describedby="dateRangeLabel"
