        ...
        <div class="row">
                ...
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8">{{ trans('admin/main.total_users') }}</span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap"> 
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8">{{ trans('admin/main.active_users') }}</span>
                            <div class="d-flex-center size-48 bg-success-30 rounded-12">
                                <x-iconsax-bul-user-tick class="icons text-success" width="24px" height="24px"/>
                            </div>
                        </div>
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $activeUsers }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8">{{ trans('admin/main.inactive_users') }}</span>
                            <div class="d-flex-center size-48 bg-accent-30 rounded-12">
                                <x-iconsax-bul-user-minus class="icons text-accent" width="24px" height="24px"/>
                            </div>
                        </div>
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $inactiveUsers }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        <div class="d-flex align-items-start justify-content-between">
                            <span class="text-gray-500 mt-8">{{ trans('admin/main.ban_users') }}</span>
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $banUsers }}</h5>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="sort" data-plugin-selectTwo class="form-control populate">
                                    ...
                                    <option value="sales_classes_asc" @if(request()->get('sort') == 'sales_classes_asc') selected @endif>{{ trans('admin/main.sales_classes_ascending') }}</option>
                                    <option value="sales_classes_desc" @if(request()->get('sort') == 'sales_classes_desc') selected @endif>{{ trans('admin/main.sales_classes_descending') }}</option>
                                    ...
                                    <option value="sales_appointments_asc" @if(request()->get('sort') == 'sales_appointments_asc') selected @endif>{{ trans('admin/main.sales_appointments_ascending') }}</option>
                                    <option value="sales_appointments_desc" @if(request()->get('sort') == 'sales_appointments_desc') selected @endif>{{ trans('admin/main.sales_appointments_descending') }}</option>
    ...
    <div class="card">
        ...
        <div class="card-header justify-content-between">
            <div>
                ...
                <p class="font-12 mt-4 mb-0 text-gray-500">{{ trans('admin/main.all_users') }}</p>
            </div>
            
            <div class="d-flex align-items-center gap-12">
                @can('admin_users_export_excel')
                    <a href="{{ getAdminPanelUrl() }}/all-users/excel?{{ http_build_query(request()->all()) }}" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
