            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $totalRegularUsers }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap"> 
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $totalOrganizationsRegularUsers }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $inactiveRegularUsers }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card-statistic">
                    ...
                    <div class="card-statistic__wrap">
                        ...
                        <h5 class="font-24 mt-12 line-height-1 text-black">{{ $banRegularUsers }}</h5>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="col-md-3 d-flex align-items-center ">
    ...
    <div class="card-header justify-content-between">
                            ...
                            @can('admin_users_export_excel')
                                   <a href="{{ getAdminPanelUrl() }}/regular-users/excel?{{ http_build_query(request()->all()) }}" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
