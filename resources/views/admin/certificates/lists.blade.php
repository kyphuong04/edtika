...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <section class="card">
                <div class="card-body">
                    <form action="{{ getAdminPanelUrl() }}/certificates" method="get" class="row mb-0">
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <div>
                                <h5 class="font-14 mb-0">{{ trans('update.quizzes_related') }}</h5>
                                <p class="font-12 mt-4 mb-0 text-gray-500">{{ trans('update.manage_certificates_list') }}</p>
                            </div>

                            <div class="d-flex align-items-center gap-12">
                                @can('admin_certificate_export_excel')
                                    <a href="{{ getAdminPanelUrl() }}/certificates/excel?{{ http_build_query(request()->all()) }}" class="btn bg-white bg-hover-gray-100 border-gray-400 text-gray-500">
                                    ...
                                    @foreach($certificates as $certificate)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <small class="d-block text-left text-gray-500">{{ !empty($certificate->quiz->webinar) ? $certificate->quiz->webinar->title : trans('update.delete_item') }})</small>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <x-iconsax-lin-import-2 class="icons text-gray-500 mr-2" width="20px" height="20px"/>
                                                </a>
                                            </td>
