                                    ...
                                    @if($offlinePayments->count() > 0)
                                        @foreach($offlinePayments as $offlinePayment)
                                            <tr>
                                                ...
                                                <td>{{ (Lang::has('admin/main.'.strtolower($offlinePayment->user->role->name))) ? trans('admin/main.'.strtolower($offlinePayment->user->role->name)) : $offlinePayment->user->role->caption }}</td>
