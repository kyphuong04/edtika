    ...
    $homeText = [
        'vi' => [
            ...
            'faq' => [
                ...
                'titleHtml' => '<span>EDTIKA</span><br>LUÔN<br>GIẢI&nbsp;ĐÁP<br>MỌI<br>THẮC&nbsp;MẮC<br>CỦA&nbsp;BẠN!',
        ...
        'en' => [
            ...
            'faq' => [
                ...
                'titleHtml' => '<span>EDTIKA</span><br>ALWAYS<br>ANSWERS<br>ALL<br>YOUR<br>QUESTIONS!',
...
@push('styles_top')
    <style>
        ...
        .edtika-auth-modal__content {
            display: grid;
            grid-template-columns: 1fr 1fr;
            min-height: min(734px, calc(100vh - 40px));
        }
        ...
        <div class="edtika-homepage__container">
            ...
            <header class="edtika-homepage__header" aria-label="{{ $isEnglish ? 'Homepage Header' : 'Đầu trang chủ' }}">
                ...
                <nav class="edtika-homepage__nav" aria-label="{{ $t['header']['mainNavAria'] }}">
                    <a href="/" class="edtika-homepage__nav-link">{{ $t['nav']['home'] }}</a>
                    <a href="/classes" class="edtika-homepage__nav-link">{{ $t['nav']['classes'] }}</a>
                    <a href="/panel/ielts-tests/practice" class="edtika-homepage__nav-link">{{ $t['nav']['placementTest'] }}</a>
                    <a href="/panel/ielts-tests/mock" class="edtika-homepage__nav-link">{{ $t['nav']['mockTest'] }}</a>
                    <a href="/panel/dictionary" class="edtika-homepage__nav-link">{{ $t['nav']['dictionary'] }}</a>
                    <a href="/blog" class="edtika-homepage__nav-link">{{ $t['nav']['news'] }}</a>
                </nav>
            ...
            <section class="edtika-bundles" aria-label="{{ $t['bundles']['aria'] }}">
                ...
                <div class="edtika-bundles__viewport">
                    <div class="edtika-bundles__track">
                        @foreach($bundleCarouselCards as $bundleIndex => $bundleCard)
                            <article class="edtika-bundles__card {{ $bundleIndex === $activeBundleIndex ? 'is-active' : '' }}">
                                ...
                                <div class="edtika-bundles__card-body">
                                    ...
                                    <div class="edtika-bundles__bottom">
                                        ...
                                        <div class="edtika-bundles__actions">
                                            ...
                                            <a href="/bundles" class="edtika-bundles__btn edtika-bundles__btn--view">{{ $t['bundles']['view'] }}</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
                ...
                <div class="edtika-bundles__footer-actions">
                    <a href="/panel/ielts-tests/practice" class="edtika-bundles__cta">{{ $t['bundles']['placementCta'] }}</a>
                    <a href="/bundles" class="edtika-bundles__cta">{{ $t['bundles']['detailCta'] }}</a>
                </div>
            </section>
                    ...
                    <div class="edtika-auth-modal__content">
                        <div class="edtika-auth-modal__form-side">
                            ...
                            <div class="edtika-auth-pane" data-auth-pane="register">
                                ...
                                <form method="POST" action="/register">
                                    ...
                                    <div class="edtika-auth-field">
                                        <label class="edtika-auth-label" for="edtikaRegisterPhone">{{ $t['auth']['phoneMethod'] }}</label>
                        ...
                        <div class="edtika-auth-modal__slider-side">
                            <div class="edtika-auth-slider">
                                <img class="edtika-auth-slider__image" src="{{ asset('store/icons/—Pngtree—abstract purple line wave background_5542852 1.png') }}" alt="{{ $t['auth']['sliderImageAlt'] }}">
    ...
    <script>
        (function () {
            ...
            var centerBundleCard = function (targetCard, useSmoothScroll) {
                ...
                var targetLeft = targetCard.offsetLeft - ((bundlesViewport.clientWidth - targetCard.clientWidth) / 2);
