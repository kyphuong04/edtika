...
<section class="mt-30">
    <div class="d-flex align-items-center justify-content-between mb-20">
        <div>
            <h1 class="section-title">Add Question</h1>
    ...
    <form action="{{ route('panel.my_ielts_tests.questions.store', [$test->id, $section->id]) }}" method="POST">
        @csrf
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="question_number" class="form-control @error('question_number') is-invalid @enderror" 
                                   value="{{ old('question_number', $section->question_start) }}" required 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Points *</label>
                            <input type="number" name="points" class="form-control" value="{{ old('points', 0) }}" required min="0" step="0.025">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" class="form-control @error('question_text') is-invalid @enderror" 
                              rows="4" required placeholder="Enter the question...">{{ old('question_text') }}</textarea>
                    @error('question_text')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="instruction" class="form-control" rows="2" 
                              placeholder="Special instructions for this question...">{{ old('instruction') }}</textarea>
                </div>

                @if(in_array($section->skill, ['writing','speaking']))
                    <div class="form-group">
                        <label>Task Image URL (optional)</label>
                        <input type="text" name="task_image_url" class="form-control" value="{{ old('task_image_url') }}" placeholder="https://example.com/image.jpg">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="explanation" class="form-control" rows="6" placeholder="Enter model answer or sample response...">{{ old('explanation') }}</textarea>
                    </div>
                @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="accept_synonyms" class="form-control" value="{{ old('accept_synonyms') }}" 
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="custom-control custom-checkbox mt-15">
                            <input type="checkbox" name="auto_gradable" class="custom-control-input" id="autoGrade" value="1" {{ old('auto_gradable') ? 'checked' : '' }}>
                            <label class="custom-control-label" for="autoGrade">Auto-gradable</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="custom-control custom-checkbox mt-15">
                            <input type="checkbox" name="case_sensitive" class="custom-control-input" id="caseSensitive" value="1" {{ old('case_sensitive') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="max_words" class="form-control" value="{{ old('max_words') }}" min="1">
                        </div>
                    </div>
                </div>
                ...
                <input type="hidden" name="table_structure" id="table_structure_input" value="{{ old('table_structure') }}">
        ...
        <div class="d-flex align-items-center justify-content-end mt-20">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-plus mr-5"></i>Create Question
            </button>
        </div>
    </form>
</section>
