...
<section class="mt-30">
    <div class="d-flex align-items-center justify-content-between mb-20">
        <h1 class="section-title">
            <i class="fas fa-dumbbell mr-10"></i>
    ...
    <div class="alert alert-success">
        ...
        <strong>Practice Test:</strong> Flexible practice with 1+ skills. Custom duration and question counts. Can set custom points per question.
    </div>

    <form action="{{ route('panel.my_ielts_tests.store_practice') }}" method="POST">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                       value="{{ old('title') }}" required placeholder="e.g. Reading Practice - True/False/Not Given">
                @error('title')
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="3"
                          placeholder="Brief description of this practice test...">{{ old('description') }}</textarea>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="practice_mode" class="form-control" required>
                            <option value="timed" {{ old('practice_mode') === 'timed' ? 'selected' : '' }}>Timed</option>
                            <option value="untimed" {{ old('practice_mode') === 'untimed' ? 'selected' : '' }}>Untimed</option>
                            <option value="adaptive" {{ old('practice_mode') === 'adaptive' ? 'selected' : '' }}>Adaptive</option>
                        </select>
                        <small class="text-muted">How students will practice</small>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="show_answers" name="show_answers_immediately" value="1">
                ...
                <div class="col-md-6">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="allow_retake" name="allow_retake" value="1" checked>
                        <label class="custom-control-label" for="allow_retake">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <button type="submit" class="btn btn-success">
                <i class="fas fa-check mr-5"></i>Create Practice Test
            </button>
        </div>
    </form>
</section>
