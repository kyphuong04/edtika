...
<div class="type-form-content" data-type-color="red">
    <h4>
        <x-iconsax-lin-map class="icons text-danger mr-8" width="20px" height="20px"/>
        Map/Plan Labeling
    ...
    <div id="mlMaxWarning" class="max-rows-warning" style="display: none;">
        <x-iconsax-lin-warning-2 class="icons" width="16px" height="16px"/> Đã đạt giới hạn tối đa 15 locations
    </div>
    
    {{-- Footer --}}
    <div class="batch-footer">
        <button type="button" class="btn btn-add-row" id="mlAddRow">
            <x-iconsax-lin-add class="icons mr-4" width="16px" height="16px"/>Thêm location
        </button>
        <div class="batch-counter">
            <x-iconsax-bul-tick-circle class="icons text-danger mr-4" width="20px" height="20px"/>
