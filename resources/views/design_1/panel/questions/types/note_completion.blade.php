...
<div class="type-form-content" data-type-color="gray">
    ...
    <div class="batch-footer">
        <button type="button" class="btn btn-add-row" id="ncAddRow" style="--type-color: #6c757d;">
            <x-iconsax-lin-add class="icons mr-4" width="16px" height="16px"/>Thêm note
        </button>
        <div class="batch-counter">
            <x-iconsax-bul-tick-circle class="icons text-secondary mr-4" width="20px" height="20px"/>
