...
<div class="type-form-content" data-type-color="cyan">
    <h4>
        <x-iconsax-lin-hierarchy-2 class="icons text-info mr-8" width="20px" height="20px"/>
    ...
    <div id="fcMaxWarning" class="max-rows-warning" style="display: none;">
        <x-iconsax-lin-warning-2 class="icons" width="16px" height="16px"/> Đã đạt giới hạn tối đa 12 steps
    </div>
    
    {{-- Footer --}}
    <div class="batch-footer">
        <button type="button" class="btn btn-add-row" id="fcAddRow">
            <x-iconsax-lin-add class="icons mr-4" width="16px" height="16px"/>Thêm step
        </button>
