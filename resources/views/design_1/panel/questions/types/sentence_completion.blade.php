...
<div class="type-form-content" data-type-color="yellow">
    ...
    <div class="max-rows-warning" id="scMaxWarning">
        <x-iconsax-lin-warning-2 class="icons mr-4" width="16px" height="16px"/>Đã đạt giới hạn 12 câu hỏi mỗi lần thêm.
    </div>
    
    <div class="batch-footer">
        <button type="button" class="btn-add-row" id="scAddRow">
            <x-iconsax-lin-add class="icons" width="16px" height="16px"/>Thêm câu
