{{-- Summary Completion (batch) --}}
@include('design_1.panel.questions.types._form_styles')

<div class="type-form-content" data-type-color="cyan">
    <h4>
        <x-iconsax-lin-document-text class="icons text-info mr-8" width="20px" height="20px"/>
        Summary Completion
    ...
    <div class="batch-footer">
        <button type="button" class="btn btn-add-row" id="sumcAddRow" style="--type-color: #17a2b8;">
            <x-iconsax-lin-add class="icons mr-4" width="16px" height="16px"/>Thêm câu
        </button>
