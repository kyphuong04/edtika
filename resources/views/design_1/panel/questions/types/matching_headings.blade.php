...
<div class="type-form-content" data-type-color="purple">
    ...
    {{-- Heading rows with paragraph dropdown --}}
    <div id="mhHeadingRows"></div>
    
    {{-- Max rows warning --}}
    <div id="mhMaxWarning" class="max-rows-warning" style="display: none;">
        <x-iconsax-lin-warning-2 class="icons" width="16px" height="16px"/> Đã đạt giới hạn tối đa 10 headings
    </div>
    
    {{-- Footer --}}
    <div class="batch-footer">
        <button type="button" class="btn btn-add-row" id="mhAddRow" style="--type-color: #667eea;">
            <x-iconsax-lin-add class="icons mr-4" width="16px" height="16px"/>Thêm heading
        </button>
        <div class="batch-counter">
            <x-iconsax-bul-tick-circle class="icons mr-4" style="color: #667eea;" width="20px" height="20px"/>
            Hợp lệ: <strong id="selectedCount" style="color: #667eea;">0</strong> câu hỏi
        </div>
    </div>
    
    {{-- Hidden field to store batch data --}}
