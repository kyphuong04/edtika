...
<div class="type-form-content" data-type-color="yellow">
    ...
    <div id="dlMaxWarning" class="max-rows-warning" style="display: none;">
        <x-iconsax-lin-warning-2 class="icons" width="16px" height="16px"/> Đã đạt giới hạn tối đa 15 labels
    </div>
    
    {{-- Footer --}}
    <div class="batch-footer">
        <button type="button" class="btn btn-add-row" id="dlAddRow">
            <x-iconsax-lin-add class="icons mr-4" width="16px" height="16px"/>Thêm label
        </button>
