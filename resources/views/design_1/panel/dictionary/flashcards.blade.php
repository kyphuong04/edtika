...
<div class="container-fluid">
    ...
    <div class="ielts-welcome-bar bg-white rounded-24 p-16 mb-20" style="margin: 20px;">
        {{-- Left: greeting --}}
        ...
        {{-- Continue → --}}
        <a href="/panel/dictionary/flashcards" class="btn btn-primary btn-sm rounded-pill px-16">
            continue →
        </a>
