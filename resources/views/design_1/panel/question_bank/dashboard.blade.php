    ...
    <div class="d-grid grid-columns-auto grid-lg-columns-4 gap-16 mb-24">
        ...
        <div class="d-flex align-items-start justify-content-between p-16 rounded-16 bg-gray-100">
            <div class="d-flex flex-column pt-8">
                ...
                <span class="font-24 font-weight-bold mt-16 text-dark">{{ $mockStats['total'] + $practiceStats['total'] }}</span>
                <span class="text-gray-500 font-12 mt-4">{{ $mockStats['total'] }}M • {{ $practiceStats['total'] }}P</span>
            </div>
        ...
        <div class="d-flex align-items-start justify-content-between p-16 rounded-16 bg-gray-100">
            <div class="d-flex flex-column pt-8">
                ...
                @endphp
                <span class="font-24 font-weight-bold mt-16 text-dark">{{ $maxSkill }}</span>
                <span class="text-gray-500 font-12 mt-4">{{ $maxCount }} questions</span>
            </div>
        ...
        <div class="d-flex align-items-start justify-content-between p-16 rounded-16 bg-gray-100">
            <div class="d-flex flex-column pt-8">
                ...
                <span class="font-24 font-weight-bold mt-16 text-dark">{{ $recentMock->count() + $recentPractice->count() }}</span>
                <span class="text-gray-500 font-12 mt-4">New questions</span>
            </div>
            <div class="d-flex-center size-48 rounded-12 bg-info-40">
                <x-iconsax-bul-clock class="icons text-info" width="24px" height="24px"/>
            </div>
        </div>
        ...
        <div class="d-flex align-items-start justify-content-between p-16 rounded-16 bg-gray-100">
            <div class="d-flex flex-column pt-8">
                ...
                @endphp
                <span class="font-24 font-weight-bold mt-16 text-dark">{{ $coveragePercent }}%</span>
                <span class="text-gray-500 font-12 mt-4">{{ $coveredSkills }}/4 skills</span>
            </div>
            <div class="d-flex-center size-48 rounded-12 bg-warning-40">
                <x-iconsax-bul-chart class="icons text-warning" width="24px" height="24px"/>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-24">
        <div class="col-lg-6">
            <div class="bg-white p-20 rounded-24">
                ...
                <div class="d-flex align-items-center justify-content-between mb-12">
                    ...
                    <span class="font-16 font-weight-bold text-dark">{{ $mockStats['total'] }}</span>
                </div>
                
                <div class="px-12 py-8 bg-gray-100 rounded-12 mb-8">
                    <div class="d-flex align-items-center justify-content-between">
                        <span class="text-gray-600 font-13">├─ Standalone:</span>
                        <span class="font-14 font-weight-500 text-info">{{ $mockStats['standalone'] }}</span>
                    </div>
                </div>
                ...
                <div class="px-12 py-8 bg-gray-100 rounded-12 mb-12">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <span class="font-14 font-weight-500 text-primary">{{ $mockStats['grouped'] }}</span>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-between pt-12 border-top">
                    ...
                    <span class="font-18 font-weight-bold text-primary">{{ $mockStats['groups'] }}</span>
                </div>
                
                <a href="{{ route('panel.question_bank.groups', 'mock') }}" class="btn btn-outline-primary w-100 mt-16">
                    <x-iconsax-bul-note-2 class="icons mr-8" width="14px" height="14px"/>
                    View Mock Groups
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="bg-white p-20 rounded-24">
                ...
                <div class="d-flex align-items-center justify-content-between mb-12">
                    <span class="text-gray-600 font-14">Total Questions:</span>
                    <span class="font-16 font-weight-bold text-dark">{{ $practiceStats['total'] }}</span>
                </div>
                
                <div class="px-12 py-8 bg-gray-100 rounded-12 mb-8">
                    <div class="d-flex align-items-center justify-content-between">
                        <span class="text-gray-600 font-13">├─ Standalone:</span>
                        <span class="font-14 font-weight-500 text-info">{{ $practiceStats['standalone'] }}</span>
                    </div>
                </div>
                ...
                <div class="px-12 py-8 bg-gray-100 rounded-12 mb-12">
                    <div class="d-flex align-items-center justify-content-between">
                        <span class="text-gray-600 font-13">└─ In Groups:</span>
                        <span class="font-14 font-weight-500 text-success">{{ $practiceStats['grouped'] }}</span>
                    </div>
                </div>
                
                <div class="d-flex align-items-center justify-content-between pt-12 border-top">
                    <span class="text-gray-600 font-14">Question Groups:</span>
                    <span class="font-18 font-weight-bold text-success">{{ $practiceStats['groups'] }}</span>
                </div>
                
                <a href="{{ route('panel.question_bank.groups', 'practice') }}" class="btn btn-outline-success w-100 mt-16">
                    <x-iconsax-bul-task-square class="icons mr-8" width="14px" height="14px"/>
    ...
    <div class="row">
        <div class="col-12 col-lg-8 mb-24">
                ...
                <div class="d-grid grid-columns-auto grid-lg-columns-4 gap-16 mt-16">
                    ...
                    @foreach($skills as $skill)
                        <div class="text-center p-16 rounded-16 bg-gray-100">
                            ...
                            <h5 class="font-14 font-weight-bold text-dark mt-12">{{ $skill['name'] }}</h5>
                            <div class="font-24 font-weight-bold text-{{ $skill['color'] }} mt-8">
                                {{ $skill['mock'] + $skill['practice'] }}
                            </div>
                            <div class="font-12 text-gray-500 mt-4">
                                M: {{ $skill['mock'] }} • P: {{ $skill['practice'] }}
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="bg-white p-20 rounded-24 mt-24">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('panel.question_bank.mock.list') }}" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                        ...
                        <div class="d-flex align-items-start justify-content-between mt-16 pt-16 border-top">
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center gap-8 mb-8">
                                    <span class="badge badge-{{ $question->difficulty_badge }}">
                                        {{ ucfirst($question->difficulty_level) }}
                                    </span>
                                    <span class="badge badge-light">{{ $question->type_name }}</span>
                                </div>
                                <h5 class="font-14 text-dark mb-4">
                                    {{ $question->skill_label }}: {{ \Illuminate\Support\Str::limit($question->question_text, 60) }}
                                </h5>
                                <span class="font-12 text-gray-500">
                                    <i class="fas fa-chart-line mr-4"></i>Used {{ $question->usage_count }} times
                                </span>
                            </div>
                            <a href="{{ route('panel.question_bank.edit', ['mock', $question->id]) }}" 
                ...
                @else
                    <div class="d-flex-center flex-column text-center bg-gray-100 border-dashed border-gray-200 rounded-16 mt-16 p-40">
                        <div class="d-flex-center size-48 rounded-12 bg-primary-40">
                            <x-iconsax-bul-book class="icons text-primary" width="24px" height="24px"/>
                        </div>
                        ...
                        <a href="{{ route('panel.question_bank.create', ['bank_type' => 'mock']) }}" 
                           class="btn btn-primary btn-sm mt-16">
                            <x-iconsax-bul-add class="icons mr-8" width="16px" height="16px"/>Add First Question
                        </a>
                    </div>
                @endif
            </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="bg-white p-20 rounded-24 mb-24">
                ...
                <a href="{{ route('panel.question_bank.mock.list') }}" 
                   class="d-flex align-items-center p-12 rounded-12 bg-gray-100 bg-hover-gray-200 mb-8">
                    <div class="d-flex-center size-32 rounded-8 bg-primary-40 mr-12">
                        <x-iconsax-bul-note-2 class="icons text-primary" width="16px" height="16px"/>
                    </div>
                    <span class="font-14 text-dark">Browse Mock Questions</span>
                </a>

                <a href="{{ route('panel.question_bank.practice.list') }}" 
                   class="d-flex align-items-center p-12 rounded-12 bg-gray-100 bg-hover-gray-200 mb-8">
                    <div class="d-flex-center size-32 rounded-8 bg-success-40 mr-12">
                        <x-iconsax-bul-task-square class="icons text-success" width="16px" height="16px"/>
                    </div>
                ...
                <div class="dropdown w-100">
                    <button class="d-flex align-items-center p-12 rounded-12 bg-gray-100 bg-hover-gray-200 mb-8 border-0 w-100 text-left dropdown-toggle" type="button" id="quickImportDropdown" data-toggle="dropdown">
                        <div class="d-flex-center size-32 rounded-8 bg-info-40 mr-12">
                            <x-iconsax-bul-document-upload class="icons text-info" width="16px" height="16px"/>
                        </div>
                ...
                <button onclick="alert('Generate Test - Coming Soon!')" 
                    ...
                    <div class="d-flex-center size-32 rounded-8 bg-warning-40 mr-12">
                        <x-iconsax-bul-magic-star class="icons text-warning" width="16px" height="16px"/>
                    </div>
                    <span class="font-14 text-dark">Generate Random Test</span>
                </button>

                @if($mockStats['total'] === 0 || $practiceStats['total'] === 0)
                    <div class="alert alert-warning mt-16 p-12 rounded-12" role="alert">
                        <x-iconsax-bul-info-circle class="icons text-warning" width="16px" height="16px"/>
                        <span class="font-12 ml-8">
                            @if($mockStats['total'] === 0)
                                No Mock questions yet!
                            @elseif($practiceStats['total'] === 0)
            ...
            <div class="bg-white p-20 rounded-24">
                <div class="d-flex align-items-center justify-content-between mb-16">
                    ...
                    <a href="{{ route('panel.question_bank.practice.list') }}" class="btn btn-sm btn-outline-success">View All</a>
                </div>
                        ...
                        <div class="d-flex flex-column mt-12 pt-12 border-top">
                            <div class="d-flex align-items-center gap-8 mb-8">
                                ...
                                @if($question->target_band)
                                    <span class="badge badge-info">B{{ $question->target_band }}</span>
                                @endif
                            </div>
                            <h5 class="font-13 text-dark">{{ \Illuminate\Support\Str::limit($question->question_text, 60) }}</h5>
                            <span class="font-12 text-gray-500 mt-4">
                                {{ $question->skill_label }} • Used {{ $question->usage_count }}x
                            </span>
                        </div>
                    @endforeach
                @else
                    <div class="d-flex-center flex-column text-center bg-gray-100 border-dashed border-gray-200 rounded-16 p-32">
                        <div class="d-flex-center size-48 rounded-12 bg-success-40">
                            <x-iconsax-bul-cup class="icons text-success" width="24px" height="24px"/>
                        </div>
                        <h4 class="mt-12 font-14 text-dark">No practice questions</h4>
                        <a href="{{ route('panel.question_bank.create', ['bank_type' => 'practice']) }}" 
