...
class Webinar extends Model
{
    ...
    public function getBriefAttribute()
    {
        ...
        return [
            ...
            'course_page_tax' => (!$this->activeSpecialOffer()) ? nicePriceWithTax($this->price)['tax'] : nicePriceWithTax($this->getPrice())['tax'],
            'price_with_discount' => nicePrice($this->getPrice()),
    ...
    public function getDetailsAttribute()
    {
        ...
        $details = [
            ...
            'quizzes_count' => $this->quizzes()->where('status', 'active')->count(),
    ...
    function checkCourseForSale($user = null)
    {
        ...
        if ($this->type == 'webinar' and $this->start_date <= time()) {
