...
use App\Models\Api\DeleteAccountRequest;
...

{
    ...
    public function deleteAccount(Request $request)
    {
        ...
        if (!empty($user)) {
            ...
            return apiResponse2(1, 'done', trans('update.delete_account_request_stored_msg'));
        }

        return apiResponse2(0, 'not_found', trans('api.auth.not_found'));
    }
