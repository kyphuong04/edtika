...
/*!****************************************************************!*\
  !*** ./resources/js/design_1/parts/course_text_lesson_page.js ***!
  \****************************************************************/
(function ($) {
  "use strict";

  $(document).ready(function () {
    var $bottomFixedCard = $('.text-lesson-bottom-fixed-card');
    var $bottomFixedProgress = $('.text-lesson-bottom-fixed-card__progress');
