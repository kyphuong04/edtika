...
/*!***********************************************!*\
  !*** ./resources/js/design_1/panel/public.js ***!
  \***********************************************/
(function ($) {
  "use strict";
  ...
  $('body').on('click', '.js-toggle-panel-sidebar', function (e) {
    ...
    var isCollapsed = $panelSidebar.hasClass('panel-sidebar--collapsed');
  ...
  function adjustContentWidth(isCollapsed) {
    ...
    var $bottomBar = $('.panel-bottom-bar');
    if (isCollapsed) {
      $content.css({
  ...
  $(document).ready(function () {
    var savedState = localStorage.getItem('panelSidebarCollapsed');
    var $panelSidebar = $('#panelSidebar');
    if (savedState === 'false') {
