...
/*!******************************************!*\
  !*** ./resources/js/admin/parts/quiz.js ***!
  \******************************************/
...
(function ($) {
  ...
  function openTextQuestionModal(quizId, questionType) {
    ...
    var modalSelector = '.textQuestionModal' + quizId + ((_modalSuffixMap$quest = modalSuffixMap[questionType]) !== null && _modalSuffixMap$quest !== void 0 ? _modalSuffixMap$quest : 'FillBlank');
  ...
  function openInlineQuestionModal(quizId, selector) {
    var questionType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    $.post(action, data, function (result) {
      ...
      if (errors && errors.errors) {
        Object.keys(errors.errors).forEach(function (key) {
          ...
          var normalizedKey = key.replace(/[^a-zA-Z0-9]+/g, '-');
          var element = form.find('.js-ajax-' + normalizedKey);
          if (!element.length) {
      ...
      if (question.type === 'descriptive') {
        ...
        if (question.question_data) {
          Object.keys(question.question_data).forEach(function (key) {
            var value = question.question_data[key];
            var element = $form.find('[name="ajax[question_data][' + key + ']"]');
            if (element.length) {
